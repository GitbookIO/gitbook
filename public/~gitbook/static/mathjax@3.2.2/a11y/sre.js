(function () {
    ...
    var __webpack_modules__ = {
            ...
            1993: function (e, t) {
                MathJax._.components.package.PackageError,
                    (t.GL = MathJax._.components.package.Package);
            },
            7086: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.AbstractAudioRenderer = void 0);
                const r = n(4886);
                t.AbstractAudioRenderer = class {
                    ...
                    getSeparator() {
                        return 'braille' === r.default.getInstance().modality
                            ? ''
                            : this.separator_;
                    }
                    error(e) {
            ...
            2599: function (e, t, n) {
                ...
                (t.mergePause = function (e, t, n) {
                    ...
                    (t.mergeMarkup = function (e, t) {
                        delete e.open,
                            t.close.forEach((t) => delete e[t]),
                            t.open.forEach((n) => (e[n] = t[n]));
                    ...
                    if (n) {
                        if (p(t) && p(n)) {
                            ...
                            const e = n.span.pop(),
                                r = t.span.shift();
                            return (
                                n.span.push(e + n.join + r),
                                (n.span = n.span.concat(t.span)),
                                void (n.join = t.join)
                            );
                        }
                ...
                function u(e, t) {
                    e.rate && (t.rate = e.rate),
                        e.pitch && (t.pitch = e.pitch),
                        e.volume && (t.volume = e.volume);
                }
                function d(e) {
                ...
                function h(e) {
                    return (
                        ...
                        Object.keys(e)[0] === i.personalityProps.PAUSE
                    );
                }
                function p(e) {
                ...
                function f(e, t, n, r, a, c = !1) {
                    if (c) {
                        ...
                        if (c && t.speech && 0 === Object.keys(n).length && p(c)) {
                            ...
                            c.span.push(t),
                                (t = new o.Span('', {})),
                                (c[i.personalityProps.JOIN] = r);
                        }
                    }
                    0 !== Object.keys(n).length && e.push(n),
                        t.speech && e.push({ span: [t], join: r }),
                        a && e.push(a);
                }
                function m(e, t) {
                    if (!t) return e;
                    ...
                    for (let r, o = 0; (r = e[o]); o++) {
                        ...
                        delete s[i.personalityProps.JOIN],
                            void 0 !== s[i.personalityProps.PAUSE] &&
                                ((e = { [i.personalityProps.PAUSE]: s[i.personalityProps.PAUSE] }),
                                delete s[i.personalityProps.PAUSE]);
                        f(t, o, m(s, n), a, e, !0);
                    }
                    return (
                        (t = t.concat(
            ...
            1292: function (e, t, n) {
                ...
                class c extends a.XmlRenderer {
                    finalize(e) {
                        return (function (e) {
                            ...
                            return (
                                r.Debugger.getInstance().output(i.formatXml(t.toString())),
                                (l = p(t)),
                                l
                            );
                        })(e);
                    ...
                    processContent(e) {
                        ...
                        for (let e, r = 0; (e = n[r]); r++)
                            e.span ? t.push(this.merge(e.span)) : s.isPauseElement(e);
                        return t.join('');
                    }
                }
                t.LayoutRenderer = c;
                ...
                const u = {
                    TABLE: function (e) {
                        let t = S(e);
                        t.forEach((e) => {
                            (e.cells = e.cells.slice(1).slice(0, -1)),
                                (e.width = e.width.slice(1).slice(0, -1));
                        });
                        const [n, r] = b(t);
                    ...
                    CAYLEY: function (e) {
                        ...
                        const [n, r] = b(t),
                            i = {
                                lfence: '',
                                rfence: '',
                                cells: r.map((e) => '\u2810' + new Array(e).join('\u2812')),
                                width: r,
                                height: 1,
                                sep: t[0].sep,
                            };
                ...
                function p(e) {
                    ...
                    for (const n of Array.from(e.childNodes))
                        t = n.nodeType !== i.NodeType.TEXT_NODE ? h(t, d(n)) : h(t, n.textContent);
                    return t;
                }
                function f(e) {
                    return e.split(/\r\n|\r|\n/).length;
                ...
                function b(e) {
                    const t = e.reduce((e, t) => Math.max(t.height, e), 0),
                        n = [];
                    for (let t = 0; t < e[0].width.length; t++)
                        n.push(e.map((e) => e.width[t]).reduce((e, t) => Math.max(e, t), 0));
                    return [t, n];
                }
                function N(e, t) {
                    const n = [];
                    for (const r of e) {
                        ...
                        for (let n = 0; n < r.cells.length; n++)
                            e.push(g(r.cells[n], r.height, t[n]));
                        (r.cells = e), n.push(r);
                    }
                    return n;
                }
                function E(e, t) {
                    if (1 === t)
                        return e.map((e) => e.lfence + e.cells.join(e.sep) + e.rfence).join('\n');
                    const n = [];
                    for (const t of e) {
                ...
                function A(e) {
                    return e.nodeType === i.NodeType.ELEMENT_NODE && 'FENCE' === i.tagName(e)
                        ? d(e)
                        : '';
                }
                function _(e) {
                    ...
                    return {
                        ...
                        sep: o,
                        cells: s,
                        height: s.reduce((e, t) => Math.max(f(t), e), 0),
                        width: s.map(m),
                    };
                }
                function C(e, t) {
            ...
            9610: function (e, t, n) {
                ...
                class o extends i.AbstractAudioRenderer {
                    constructor() {
                        super(...arguments),
                            (this.ignoreElements = [r.personalityProps.LAYOUT]),
                        ...
                        for (let e, a = 0; (e = t[a]); a++)
                            o.isMarkupElement(e) ||
                                (o.isPauseElement(e)
                                    ? s && (i = o.mergePause(i, e, Math.max))
                                    : (i &&
                                          ((n += this.pause(i[r.personalityProps.PAUSE])),
                                          (i = null)),
            ...
            8078: function (e, t, n) {
                ...
                class o extends i.XmlRenderer {
                    ...
                    pause(e) {
                        return (
                            '<BREAK MSEC="' + this.pauseValue(e[r.personalityProps.PAUSE]) + '"/>'
                        );
                    }
                    prosodyElement(e, t) {
                        switch (((t = this.applyScaleFunction(t)), e)) {
            ...
            4115: function (e, t, n) {
                ...
                class s extends o.XmlRenderer {
                    ...
                    pause(e) {
                        return (
                            '<break time="' + this.pauseValue(e[i.personalityProps.PAUSE]) + 'ms"/>'
                        );
                    }
                    prosodyElement(e, t) {
                        const n =
                            (t = Math.floor(this.applyScaleFunction(t))) < 0
                                ? t.toString()
                                : '+' + t.toString();
                        return (
                            '<prosody ' +
                ...
                class i extends r.SsmlRenderer {
                    ...
                    merge(e) {
                        ...
                        for (let n = 0; n < e.length; n++) {
                            ...
                            o &&
                                !i.MARKS[o] &&
                                (t.push('<mark name="' + o + '"/>'), (i.MARKS[o] = !0)),
                            ...
                            if (e.span) n.push(this.merge(e.span));
                                ...
                                if (e.close.length)
                                    for (let t = 0; t < e.close.length; t++) {
                                        const t = o.pop();
                                        if (-1 === e.close.indexOf(t))
                                            throw new r.SREError(
                                                'Unknown closing markup element: ' + t,
                                            );
                ...
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    ...
                    (t.interleaveLists = function (e, t) {
                        ...
                        for (; e.length || t.length; )
                            e.length && n.push(e.shift()), t.length && n.push(t.shift());
                        return n;
                    }),
                    (t.setdifference = n),
            ...
            9501: function (e, t, n) {
                ...
                function s(e, t) {
                    ...
                    'undefined' == typeof wgxpath && n < 10
                        ...
                        : n >= 10 ||
                          ...
                          e
                              ? r.default.wgxpath.install({ document: document })
                              : r.default.wgxpath.install(),
                ...
                function c(e) {
                    ...
                    (t.type = 'text/javascript'),
                        (t.src = e),
                        r.default.document.head
                            ? r.default.document.head.appendChild(t)
                            : r.default.document.body.appendChild(t);
                }
                (t.detectIE = function () {
                    return (
                    ...
                    (t.parseInput = function (e) {
                        ...
                        try {
                            ...
                            return r.default.getInstance().mode === i.Mode.HTTP
                                ? ((s.xpath.currentDocument = e),
                                  a ? e.body.childNodes[0] : e.documentElement)
                                : e.documentElement;
                        } catch (e) {
                    ...
                    (t.formatXml = function (e) {
                        ...
                        for (
                            ...
                            if (e.match(/^<\w[^>/]*>[^>]+$/)) {
                                ...
                                t[0]
                                    ? t[1]
                                        ? ((e += i.shift().slice(0, -t[1].length)),
                                          t[1].trim() && i.unshift(t[1]))
                                        : (e += i.shift())
                                    : (n = 1);
            ...
            4886: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.EnginePromise = t.SREError = void 0);
                const r = n(8310),
                    i = n(4998),
                    o = n(1984),
                    s = n(4513);
                ...
                class c {
                    constructor() {
                        (this.customLoader = null),
                            ...
                            (this.defaultParser = new r.DynamicCstrParser(
                                r.DynamicCstr.DEFAULT_ORDER,
                            )),
                    ...
                    setDynamicCstr(e) {
                        if (
                            (this.defaultLocale &&
                                (r.DynamicCstr.DEFAULT_VALUES[r.Axis.LOCALE] = this.defaultLocale),
                            e)
                        ) {
                            const t = Object.keys(e);
                    ...
                    configurate(e) {
                        this.mode !== i.Mode.HTTP ||
                            this.config ||
                            (!(function (e) {
                                const t = document.documentElement.querySelectorAll(
                            ...
                            (function (e) {
                                if ('undefined' != typeof SREfeature)
                                    for (const [t, n] of Object.entries(SREfeature)) e[t] = n;
                            })(e);
                    }
                    setCustomLoader(e) {
            ...
            4998: function (e, t) {
                ...
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.DOMAIN_TO_STYLES =
                        t.Markup =
                        t.Speech =
                        t.personalityPropList =
                        t.personalityProps =
                        t.Mode =
                            void 0),
                    (function (e) {
                        (e.SYNC = 'sync'), (e.ASYNC = 'async'), (e.HTTP = 'http');
                    })(t.Mode || (t.Mode = {})),
                    (function (e) {
                        (e.PITCH = 'pitch'),
                            (e.RATE = 'rate'),
                            ...
                            (e.JOIN = 'join'),
                            (e.LAYOUT = 'layout');
                    })((n = t.personalityProps || (t.personalityProps = {}))),
                    (t.personalityPropList = [n.PITCH, n.RATE, n.VOLUME, n.PAUSE, n.JOIN]),
                    (function (e) {
            ...
            985: function (e, t, n) {
                ...
                t.setup = function (e) {
                    return r(this, void 0, void 0, function* () {
                        ...
                        'default' !== e.domain ||
                            ('speech' !== e.modality && e.modality && 'speech' !== t.modality) ||
                            (e.domain = 'mathspeak');
                        const n = (n) => {
                            void 0 !== e[n] && (t[n] = e[n]);
                        };
            ...
            7129: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.localePath = t.makePath = void 0);
                const r = n(4755);
                function i(e) {
                    return e.match('/$') ? e : e + '/';
                }
            ...
            3539: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.KeyProcessor = t.Processor = void 0);
                const r = n(6988);
                class i {
                    constructor(e, t) {
                        (this.name = e),
                ...
                (t.Processor = i),
                    (i.LocalState = { walker: null, speechGenerator: null, highlighter: null });
                class o extends i {
                    constructor(e, t) {
            ...
            9615: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.keypress = t.output = t.print = t.process = t.set = void 0);
                const r = n(4253),
                    i = n(7450),
                    o = n(9009),
                    s = n(4524),
                    ...
                    b(
                        new m.Processor('semantic', {
                            ...
                            postprocessor: function (e, t) {
                                ...
                                if (n === f.Speech.SHALLOW)
                                    return e.setAttribute('speech', r.finalize(o)), e;
                                const s = g.evalXPath('.//*[@id]', e),
                                    a = g.evalXPath('.//*[@id]', i);
                                for (let e, t, n = 0; (e = s[n]), (t = a[n]); n++)
                                    (o = l.computeMarkup(t)),
                                        e.setAttribute('speech', r.finalize(o));
                                return e;
                            },
                            pprint: function (e) {
                        ...
                        new m.Processor('json', {
                            ...
                            postprocessor: function (e, t) {
                                ...
                                const i = h.parseInput(t),
                                    ...
                                    s = l.computeMarkup(o);
                                if (n === f.Speech.SHALLOW)
                                    return (e.stree.speech = r.finalize(s)), e;
                                const c = (e) => {
                        ...
                        new m.Processor('walker', {
                            processor: function (e) {
                                ...
                                (m.Processor.LocalState.speechGenerator = t),
                                    ...
                                    (m.Processor.LocalState.highlighter = o.highlighter(
                                        { color: 'black' },
                                        { color: 'white' },
                                        { renderer: 'NativeMML' },
                                    ));
                    ...
                    b(
                        new m.KeyProcessor('move', {
                            processor: function (e) {
                                ...
                                return !1 === m.Processor.LocalState.walker.move(e)
                                    ? r.error(e)
                        ...
                        new m.Processor('vulgar', {
                            processor: function (e) {
                                ...
                                return isNaN(t) || isNaN(n)
                                    ? ''
                                    : E('speech', `<mfrac><mn>${t}</mn><mn>${n}</mn></mfrac>`);
                            },
                        }),
                    );
            },
            9037: function (e, t, n) {
                    ...
                    switch (i.default.getInstance().mode) {
                        case s.Mode.ASYNC:
                            return (function (e, t, n) {
                                return r(this, void 0, void 0, function* () {
                                    const r = yield l.default.fs.promises.readFile(t, {
                                            encoding: 'utf8',
                                        }),
                                        o = c.output(e, r);
                                    if (n)
                        ...
                        default:
                            throw new i.SREError(
                                `Can process files in ${i.default.getInstance().mode} mode`,
                            );
                    }
                }
                (t.version = u.Variables.VERSION),
                    ...
                    (t.engineSetup = function () {
                        const e = ['mode'].concat(
                                i.default.STRING_FEATURES,
                                i.default.BINARY_FEATURES,
                            ),
            ...
            4755: function (__unused_webpack_module, exports, __webpack_require__) {
                ...
                (exports.default = SystemExternal),
                    ...
                    (SystemExternal.documentSupported =
                        SystemExternal.windowSupported && !(void 0 === window.document)),
                    ...
                    (SystemExternal.xpath = SystemExternal.documentSupported
                        ...
                        : (function () {
                              ...
                              return (
                                  SystemExternal.extRequire('wicked-good-xpath').install(e),
                                  (e.document.XPathResult = e.XPathResult),
                                  e.document
                              );
                          })()),
            ...
            4513: function (e, t) {
                ...
                class n {
                    static ensureLocale(e, t) {
                        return n.LOCALES.get(e)
                            ? e
                            : (console.error(
                                  `Locale ${e} does not exist! Using ${n.LOCALES.get(t)} instead.`,
                              ),
                              t);
                    }
                }
            ...
            5024: function (e, t, n) {
                ...
                t.xpath = {
                    ...
                    createNSResolver: s()
                        ...
                        : o.default.xpath.createNSResolver,
                };
                const a = {
                ...
                function u(e, n, o) {
                    return r.default.getInstance().mode !== i.Mode.HTTP ||
                        r.default.getInstance().isIE ||
                        r.default.getInstance().isEdge
                ...
                (t.evalXPath = d),
                    ...
                    (t.updateEvaluator = function (e) {
                        ...
                        n && n.evaluate
                            ? (t.xpath.currentDocument = n)
                            : e.ownerDocument && (t.xpath.currentDocument = e.ownerDocument);
                    });
            },
            9341: function (e, t) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.AbstractEnrichCase = void 0);
                ...
                class a extends i.AbstractEnrichCase {
                    ...
                    getMathml() {
                        ...
                        return (
                            ...
                            o.addCollapsedAttribute(this.mml, [
                                this.semantic.id,
                                [e.id, t.id, r.id],
                                n.id,
                            ]),
                ...
                class d extends o.AbstractEnrichCase {
                    ...
                    static test(e) {
                        return !(
                            !e.mathmlTree ||
                            !e.fencePointer ||
                            e.mathmlTree.getAttribute('data-semantic-type')
                        );
                    }
                    ...
                    getFencedMml_() {
                        ...
                        for (
                            e = e === this.fencedMml ? e : this.fencedMml;
                            e && e !== this.cfenceMml;
                    ...
                    getFencesMml_() {
                        ...
                        for (; !((this.ofenceMml && this.cfenceMml) || e === this.fenced); )
                            -1 === t.indexOf(e.fencePointer) ||
                                this.ofenceMml ||
                                (this.ofenceMml = e.mathmlTree),
                                -1 === n.indexOf(e.fencePointer) ||
                                    this.cfenceMml ||
                                    (this.cfenceMml = e.mathmlTree),
                                (e = e.childNodes[0]);
                    ...
                    rewrite_() {
                        ...
                        for (
                            (0, u.setAttributes)(n, this.fenced.parent);
                            !this.fencedElement(e);
                            ...
                            if (o) e = o;
                                ...
                                const t = [];
                                for (let n, r = 1; (n = e.childNodes[r]); r++)
                                    t.push(l.walkTree(n));
                                e = e.childNodes[0];
                            }
                            ...
                            r.replaceNode(i, s),
                                r.replaceNode(n, i),
                                r.replaceNode(i.childNodes[0], n),
                                r.replaceNode(s, a),
                                t || (t = i);
                        }
                        return (
                            l.walkTree(this.ofence),
                            l.walkTree(this.cfence),
                        ...
                        if (
                            ('MSUBSUP' === n
                                ...
                                : 'MMULTISCRIPTS' === n &&
                                  ...
                                  (o =
                                      i && e.childNodes[0] && 'subsup' === e.childNodes[0].role
                                          ? e.childNodes[0]
                                          : e)),
                            !o)
                        )
                ...
                class a extends i.AbstractEnrichCase {
                    ...
                    static test(e) {
                        ...
                        const t = r.tagName(e.mathmlTree),
                            n = e.type;
                        return (
                            (('limupper' === n || 'limlower' === n) &&
                                ('MSUBSUP' === t || 'MUNDEROVER' === t)) ||
                            ('limboth' === n &&
                                ('MSUB' === t || 'MUNDER' === t || 'MSUP' === t || 'MOVER' === t))
                        );
                    }
                    static walkTree_(e) {
                        e && o.walkTree(e);
                    ...
                    getMathml() {
                        return (
                            this.semantic.contentNodes.length &&
                                i.walkTree(this.semantic.contentNodes[0]),
            ...
            2124: function (e, t, n) {
                ...
                class a extends i.AbstractEnrichCase {
                    ...
                    static multiscriptIndex(e) {
                        return 'punctuated' === e.type && 'dummy' === e.contentNodes[0].role
                            ? o.collapsePunctuated(e)
                            : (o.walkTree(e), e.id);
                    }
                    static createNone_(e) {
                        const t = r.createElement('none');
                        return (
                            e && (0, s.setAttributes)(t, e),
                    ...
                    completeMultiscript(e, t) {
                        ...
                        const c = (e) => {
                            for (let t, r = 0; (t = e[r]); r++) {
                                ...
                                if (
                                    e &&
                                    t === parseInt(o.getInnerNode(e).getAttribute(s.Attribute.ID))
                                )
                                    o
                                        .getInnerNode(e)
                                        .setAttribute(
                        ...
                        c(e),
                            n[i] && 'MPRESCRIPTS' !== r.tagName(n[i])
                                ? this.mml.insertBefore(n[i], r.createElement('mprescripts'))
                                : i++,
                            c(t);
                    }
                }
            ...
            4308: function (e, t, n) {
                ...
                class c extends o.CaseMultiindex {
                    static test(e) {
                        ...
                        return (
                            'MMULTISCRIPTS' === r.tagName(e.mathmlTree) &&
                            ('superscript' === e.type || 'subscript' === e.type)
                        );
                    }
                    constructor(e) {
                    ...
                    getMathml() {
                        ...
                        if (
                            ...
                            (e = r.childNodes[0]),
                                (t = o.CaseMultiindex.multiscriptIndex(
                            ...
                            s.addCollapsedAttribute(this.mml, c),
                                ...
                                this.completeMultiscript(
                                    i.SemanticSkeleton.interleaveIds(n, t),
                                    [],
                                );
                        } else {
                            (e = this.semantic.childNodes[0]),
                                (t = o.CaseMultiindex.multiscriptIndex(
                                    this.semantic.childNodes[1],
                                ));
                        ...
                        return (
                            s
                                .getInnerNode(c)
                                .setAttribute(a.Attribute.PARENT, this.semantic.id.toString()),
                            r.unshift(e.id),
                ...
                class a extends i.AbstractEnrichCase {
                    ...
                    getMathml() {
                        const e = o.cloneContentNode(this.semantic.contentNodes[0]),
                            t = this.semantic.contentNodes[1]
                                ? o.cloneContentNode(this.semantic.contentNodes[1])
                                : null;
                        if (((this.inner = this.semantic.childNodes.map(o.walkTree)), this.mml))
                            if ('MFENCED' === r.tagName(this.mml)) {
                                const n = this.mml.childNodes;
                                this.mml.insertBefore(e, n[0] || null),
                                    t && this.mml.appendChild(t),
                                    (this.mml = o.rewriteMfenced(this.mml));
                            } else {
                                const n = [e, this.mml];
                                t && n.push(t), (this.mml = o.introduceNewLayer(n, this.semantic));
                            }
                        else
                            this.mml = o.introduceNewLayer(
                                [e].concat(this.inner, [t]),
                                this.semantic,
                            );
                        return (0, s.setAttributes)(this.mml, this.semantic), this.mml;
                    }
                ...
                class a extends i.CaseMultiindex {
                    ...
                    getMathml() {
                        ...
                        return (
                            ...
                            this.completeMultiscript(
                                r.SemanticSkeleton.interleaveIds(n, a),
                                r.SemanticSkeleton.interleaveIds(e, t),
                            ),
                            this.mml
                        );
                    }
            ...
            598: function (e, t, n) {
                ...
                class s extends r.AbstractEnrichCase {
                    ...
                    static test(e) {
                        return (
                            'punctuated' === e.type &&
                            ('text' === e.role || e.contentNodes.every((e) => 'dummy' === e.role))
                        );
                    }
                    getMathml() {
                        const e = [],
            ...
            7450: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.prepareMmlString =
                        t.testTranslation__ =
                        t.semanticMathml =
                        t.semanticMathmlSync =
                        t.semanticMathmlNode =
                            void 0);
                const r = n(1984),
                    i = n(6671),
                    o = n(4886),
            ...
            8171: function (e, t) {
                ...
                function i(e, t) {
                    const r = [];
                    'mglyph' === t.role && r.push('image'),
                        t.attributes.href && r.push('link'),
                        r.length && e.setAttribute(n.POSTFIX, r.join(' '));
                }
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.addPrefix =
                    ...
                    (t.setAttributes = function (e, o) {
                        ...
                        for (let n, r = 0; (n = s[r]); r++)
                            e.setAttribute(t.Prefix + n[0].toLowerCase(), n[1]);
            ...
            9775: function (e, t) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    ...
                    (t.getCase = function (e) {
                        for (let n, r = 0; (n = t.factory[r]); r++)
                            if (n.test(e)) return n.constr(e);
                        return null;
                    }),
                    (t.factory = []);
            },
            ...
            8672: function (e, t, n) {
                ...
                function h(e) {
                    ...
                    if (((n = e.mathmlTree), null === n))
                        r.Debugger.getInstance().output('Walktree Case 1'), (n = p(s, e));
                    else {
                        const e = v(s);
                        r.Debugger.getInstance().output('Walktree Case 2'),
                            e
                                ? (r.Debugger.getInstance().output('Walktree Case 2.1'),
                                  (n = e.parentNode))
                                : (r.Debugger.getInstance().output('Walktree Case 2.2'),
                                  (n = U(n)));
                    }
                ...
                function p(e, t) {
                    ...
                    if (s !== _.VALID || !l.hasEmptyTag(o))
                        if (
                            (r.Debugger.getInstance().output('Walktree Case 1.1'),
                            (o = i.createElement('mrow')),
                            s === _.PRUNED)
                        )
                            r.Debugger.getInstance().output('Walktree Case 1.1.0'),
                                (o = f(o, n.node, e));
                        else if (e[0]) {
                ...
                function m(e, t) {
                    for (const n of u.EnrichAttributes)
                        e.hasAttribute(n) &&
                            (t.setAttribute(n, e.getAttribute(n)), e.removeAttribute(n));
                }
                function g(e, t) {
                ...
                function S(e, t, n) {
                    ...
                    for (; o.length; ) {
                        ...
                        0 !== t.length &&
                            (1 !== t.length
                                ? (s ? e.setAttribute('AuxiliaryImplicit', !0) : (s = !0),
                                  (o = t.concat(o)))
                                : r.push(e));
                    }
                    const a = [],
                ...
                function b(e) {
                    ...
                    for (; n.length; ) {
                        ...
                        e.nodeType === i.NodeType.ELEMENT_NODE &&
                            (e.hasAttribute(u.Attribute.TYPE)
                                ? t.push(e)
                                : (n = i.toArray(e.childNodes).concat(n)));
                    }
                    return t;
                }
                function N(e, t, n) {
                    const r =
                        'implicit' === n.role && a.flags.combine_juxtaposition
                            ? S(e, t, n)
                            : i.toArray(e.childNodes);
                    if (!r.length)
                ...
                function E(e, t, n) {
                    ...
                    for (
                        ;
                        i && i.firstChild === r && !r.hasAttribute('AuxiliaryImplicit') && i !== e;
                ...
                function A(e, t) {
                    ...
                    if (
                        ...
                        for (let n, r = 0; (n = e.attributes[r]); r++)
                            t.hasAttribute(n.nodeName) || t.setAttribute(n.nodeName, n.nodeValue);
                ...
                function L(e) {
                    ...
                    return 1 === n.length &&
                        l.hasEmptyTag(n[0]) &&
                        !n[0].hasAttribute(u.Attribute.TYPE)
                        ? L(n[0])
                        : e;
                }
                function R(e) {
                ...
                function D(e) {
                    ...
                    for (let n, r = 0; (n = e.attributes[r]); r++)
                        -1 === ['open', 'close', 'separators'].indexOf(n.name) &&
                ...
                function w(e) {
                    ...
                    return (
                        t.appendChild(n),
                        u.setAttributes(t, e),
                        t.setAttribute(u.Attribute.ADDED, 'true'),
                        t
                    );
                }
                function k(e, t) {
                ...
                function B(e, t, n, r) {
                    const i = r || !1;
                    j(e, 'Original MathML', i),
                        j(n, 'Semantic Tree', i),
                        j(t, 'Semantically enriched MathML', i);
                }
                function j(e, t, n) {
                ...
                (t.SETTINGS = { collapsed: !0, implicit: !0 }),
                    (t.enrich = function (e, t) {
                        ...
                        return (
                            h(t.root),
                            o.default.getInstance().structure &&
                                e.setAttribute(
                                    u.Attribute.STRUCTURE,
                                    c.SemanticSkeleton.fromStructure(e, t).toString(),
                                ),
                    ...
                    (t.collapsePunctuated = function (e, t) {
                        ...
                        for (let t, o = 0; (t = e.childNodes[o]); o++) {
                            ...
                            r.push(e);
                            const o = U(e);
                            i && !n && o.setAttribute(u.Attribute.PARENT, i.id.toString()),
                                s.push(t.id);
                        }
                        return s;
                    }),
            ...
            7228: function (e, t, n) {
                ...
                class o {
                    ...
                    unhighlight() {
                        ...
                        e &&
                            e.forEach((e) => {
                                this.isHighlighted(e.node) &&
                                    (this.unhighlightNode(e), this.unsetHighlighted(e.node));
                            });
                    }
                    unhighlightAll() {
                    ...
                    addEvents(e, t) {
                        ...
                        for (let e, r = 0; (e = n[r]); r++)
                            for (const n in t) e.addEventListener(n, t[n]);
                    }
                    getMactionNodes(e) {
                    ...
                    uncolorizeAll(e) {
                        r.evalXPath(`.//*[@${i.Attribute.ID}]`, e).forEach((e) =>
                            this.uncolorize(e),
                        );
                    }
                    colorize(e) {
                        ...
                        e.hasAttribute(t) &&
                            (e.setAttribute(t + '-old', e.style.color),
                            (e.style.color = e.getAttribute(t)));
                    }
                    uncolorize(e) {
            ...
            1123: function (e, t) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.ContrastPicker = t.ColorPicker = void 0);
                const n = {
                ...
                function r(e, t) {
                    ...
                    return (
                        ...
                        (function (e) {
                            const t = (e) => (
                                (e = Math.max(e, 0)), (e = Math.min(255, e)), Math.round(e)
                            );
                            return (
                                (e.red = t(e.red)),
                                (e.green = t(e.green)),
                ...
                class i {
                    constructor(e, t) {
                        (this.foreground = r(t, i.DEFAULT_FOREGROUND_)),
                            (this.background = r(e, i.DEFAULT_BACKGROUND_));
                    }
                    static toHex(e) {
                ...
                (t.ColorPicker = i),
                    (i.DEFAULT_BACKGROUND_ = 'blue'),
                    (i.DEFAULT_FOREGROUND_ = 'black');
                t.ContrastPicker = class {
                    ...
                    generate() {
                        return (
                            ...
                            'rgb(' +
                                (e = {
                                    red: Math.round(255 * t.red),
                                    green: Math.round(255 * t.green),
                ...
                class i extends r.AbstractHighlighter {
                    ...
                    highlightNode(e) {
                        const t = {
                            ...
                            n = this.colorString();
                        return (
                            (e.style.backgroundColor = n.background),
                            (e.style.color = n.foreground),
                            t
                        );
                    }
                    unhighlightNode(e) {
                        (e.node.style.backgroundColor = e.background),
                            (e.node.style.color = e.foreground);
                    }
                }
                t.CssHighlighter = i;
            },
            9009: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.highlighterMapping_ = t.addEvents = t.highlighter = void 0);
                const r = n(7567),
                    i = n(1123),
                    o = n(9400),
                    s = n(7872),
            ...
            7872: function (e, t, n) {
                ...
                class o extends i.AbstractHighlighter {
                    ...
                    unhighlightNode(e) {
                        const t = e.node;
                        (t.style.color = e.foreground),
                            (t.style.position = e.position),
                            e.box && e.box.parentNode.removeChild(e.box);
                    }
                }
                t.HtmlHighlighter = o;
            },
                ...
                class o extends i.AbstractHighlighter {
                    ...
                    unhighlightNode(e) {
                        if ('background' in e)
                            return (
                                (e.node.style.backgroundColor = e.background),
                                void (e.node.style.color = e.foreground)
                            );
                        e.foreground
                            ? e.node.nextSibling.setAttribute('fill', e.foreground)
                            : e.node.nextSibling.removeAttribute('fill'),
                            e.node.parentNode.removeChild(e.node);
                    }
                    isMactionNode(e) {
                        let t = e.className || e.getAttribute('class');
                        return (
                            (t = void 0 !== t.baseVal ? t.baseVal : t),
                            !!t && !!t.match(new RegExp(this.mactionName))
                        );
                    }
                }
                t.SvgHighlighter = o;
                ...
                class c extends a.SvgHighlighter {
                    ...
                    unhighlightNode(e) {
                        ...
                        if (t && t.hasAttribute('sre-highlighter-added'))
                            return (
                                e.foreground
                                    ? e.node.setAttribute('fill', e.foreground)
                                    : e.node.removeAttribute('fill'),
                    ...
                    getMactionNodes(e) {
                        return Array.from(
                            i.evalXPath(`.//*[@data-mml-node="${this.mactionName}"]`, e),
                        );
                    }
                }
            ...
            1473: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.StaticTrieNode = t.AbstractTrieNode = void 0);
                const r = n(1984),
                    i = n(9259);
                class o {
                    constructor(e, t) {
                ...
                t.StaticTrieNode = class extends o {
                    ...
                    setRule(e) {
                        this.rule_ &&
                            r.Debugger.getInstance().output(
                                'Replacing rule ' + this.rule_ + ' with ' + e,
                            ),
                            (this.rule_ = e);
                    }
                    toString() {
                ...
                class o {
                    ...
                    static collectRules_(e) {
                        ...
                        for (; n.length; ) {
                            const e = n.shift();
                            if (
                                e.getKind() === r.TrieNodeKind.QUERY ||
                                e.getKind() === r.TrieNodeKind.BOOLEAN
                            ) {
                                const n = e.getRule();
                                n && t.unshift(n);
                            }
                        ...
                        for (; t.length; ) {
                            ...
                            for (; n.length; ) {
                                n.shift()
                                    .getChildren()
                                    .forEach((t) => {
                                        (t.getKind() === r.TrieNodeKind.DYNAMIC &&
                                            -1 === e.indexOf(t.getConstraint())) ||
                                            i.push(t);
                                    });
                            }
                            n = i.slice();
                    ...
                    enumerate_(e, t) {
                        ...
                        for (let e, i = 0; (e = n[i]); i++)
                            e.kind === r.TrieNodeKind.DYNAMIC &&
                                (t[e.getConstraint()] = this.enumerate_(e, t[e.getConstraint()]));
                        return t;
                    }
                    addNode_(e, t, n, r) {
                        let o = e.getChild(t);
            ...
            9146: function (e, t, n) {
                ...
                function p(e) {
                    ...
                    if (e.match(/^self::\w+:\w+$/)) {
                        ...
                        return (e) =>
                            e.localName && e.localName.toUpperCase() === r && e.namespaceURI === n;
                    }
                    if (e.match(/^@\w+$/)) {
                        const t = e.slice(1);
                    ...
                    if (e.match(/^@\w+="[\w\d ]+"$/)) {
                        const t = e.split('='),
                            ...
                            r = t[1].slice(1, -1);
                        return (e) =>
                            e.hasAttribute && e.hasAttribute(n) && e.getAttribute(n) === r;
                    }
                    if (e.match(/^@\w+!="[\w\d ]+"$/)) {
                        const t = e.split('!='),
                            n = t[0].slice(1),
                                ...
                                (null ===
                                    (i =
                                        null === (n = e.parentNode) || void 0 === n
                                            ? void 0
                                            : n.parentNode) || void 0 === i
                                    ? void 0
                                    : i.tagName) && r.tagName(e.parentNode.parentNode) === t
                            );
                        };
                    }
                ...
                class f extends c.StaticTrieNode {
                    ...
                    applyTest(e) {
                        return this.test
                            ? this.test(e)
                            : this.context.applyQuery(e, this.constraint) === e;
                    }
                }
                t.QueryTrieNode = f;
                class m extends c.StaticTrieNode {
                    ...
                    applyTest(e) {
                        return this.test
                            ? this.test(e)
                            : this.context.applyConstraint(e, this.constraint);
                    }
                }
                t.BooleanTrieNode = m;
            },
            2371: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.completeLocale = t.getLocale = t.setLocale = t.locales = void 0);
                const r = n(4886),
                    i = n(4513),
                    o = n(1058),
                    s = n(8597),
                    ...
                    b = n(4524);
                function N() {
                    const e = i.Variables.ensureLocale(
                        r.default.getInstance().locale,
                        r.default.getInstance().defaultLocale,
                    );
                ...
                (t.locales = {
                        ...
                        if (
                            ((function (e) {
                                ...
                                -1 === e.SUBISO.all.indexOf(t) &&
                                    (r.default.getInstance().subiso = e.SUBISO.default);
                                e.SUBISO.current = r.default.getInstance().subiso;
                            })(e),
                            e)
                        ) {
                            for (const t of Object.getOwnPropertyNames(e)) b.LOCALE[t] = e[t];
                            for (const [t, n] of Object.entries(e.CORRECTIONS))
                                o.Grammar.getInstance().setCorrection(t, n);
                        }
                    }),
                    (t.getLocale = N),
                    (t.completeLocale = function (e) {
                        ...
                        if (!n)
                            return void console.error('Locale ' + e.locale + ' does not exist!');
            ...
            4524: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.createLocale = t.LOCALE = void 0);
                const r = n(4277);
                function i() {
                    return {
            ...
            3319: function (e, t, n) {
                ...
                (t.nestingToString = function (e) {
                    ...
                    (t.combinePostfixIndex = function (e, t) {
                        return e === r.LOCALE.MESSAGES.MS.ROOTINDEX ||
                            e === r.LOCALE.MESSAGES.MS.INDEX
                            ? e
                            : e + ' ' + t;
                    }),
                    ...
                    (t.localeFontCombiner = function (e) {
                        return 'string' == typeof e
                            ...
                            : {
                                  font: e[0],
                                  combiner:
                                      r.LOCALE.COMBINERS[e[1]] ||
                                      i.Combiners[e[1]] ||
                                      r.LOCALE.ALPHABETS.combiner,
                              };
                    });
            },
            8597: function (e, t, n) {
                        ...
                        a ||
                            (a = (function () {
                                ...
                                return (
                                    ...
                                    (e.FUNCTIONS.fontRegexp = (t) =>
                                        t === e.ALPHABETS.capPrefix.default
                                            ? RegExp('^' + t + ' ')
                                            : RegExp(' ' + t + '$')),
                        ...
                        l ||
                            (l = (function () {
                                ...
                                return (
                                    ...
                                    (e.FUNCTIONS.radicalNestDepth = (t) =>
                                        t > 1 ? e.NUMBERS.numberToWords(t) + 'fach' : ''),
                                    ...
                                    (e.CORRECTIONS.article = (e) => {
                                        ...
                                        return 'dative' === t
                                            ? { der: 'dem', die: n ? 'den' : 'der', das: 'dem' }[e]
                                            : e;
                                    }),
                                    (e.CORRECTIONS.masculine = (e) =>
                                        'dative' === r.Grammar.getInstance().getParameter('case')
                                            ? e + 'n'
                                            : e),
                                    e
                                );
                        ...
                        c ||
                            (c = (function () {
                                ...
                                return (
                                    ...
                                    (e.CORRECTIONS.article = (e) =>
                                        r.Grammar.getInstance().getParameter('noArticle') ? '' : e),
                                    e
                                );
                            })()),
                        c
                        ...
                        c ||
                            (c = (function () {
                                ...
                                return (
                                    ...
                                    (e.FUNCTIONS.combineNestedFraction = (e, t, n) =>
                                        n.replace(/ $/g, '') + t + e),
            ...
            13: function (e, t, n) {
                ...
                const r = n(3319),
                    ...
                    a = function (e, t, n) {
                        return (
                            e.match(/^[a-zA-Z]$/) && (t = t.replace('cerchiato', 'cerchiata')),
                            (e = n ? e + ' ' + n : e),
                            t ? e + ' ' + t : e
                        );
                    };
            ...
            2913: function (e, t, n) {
                ...
                const r = n(4524),
                    ...
                    o = n(9385),
                    s = function (e) {
                        return e.match(RegExp('^' + h.ALPHABETS.languagePrefix.english))
                            ? e.slice(1)
                            : e;
                    },
                    a = function (e, t, n) {
            ...
            4277: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.SUBISO = t.FUNCTIONS = t.ALPHABETS = t.NUMBERS = t.MESSAGES = void 0);
                const r = n(9385);
                (t.MESSAGES = function () {
                    return {
                        MS: {},
                    ...
                    (t.ALPHABETS = function () {
                        return {
                            ...
                            languagePrefix: {},
                            digitTrans: {
                                default: r.identityTransformer,
                                mathspeak: r.identityTransformer,
                                clearspeak: r.identityTransformer,
                            },
            ...
            165: function (e, t, n) {
                        ...
                        if (r) {
                            ...
                            if (t)
                                if (1 === t)
                                    ...
                                    const t = o(r);
                                    (e = 1 === r ? e : e.replace(/\u00f3$/, 'ons')),
                                        (n = t + a.numSep + e + (n ? a.numSep + n : ''));
                                }
                            else n = i(r);
                        }
                ...
                (a.numericOrdinal = s),
                    ...
                    (a.numberToOrdinal = function (e, t) {
                        ...
                        const n = o(e);
                        return n.match(/mil$/)
                            ? n.replace(/mil$/, 'mil\xb7l\xe8sima')
                            : n.match(/u$/)
                              ? n.replace(/u$/, 'vena')
                              : n.match(/a$/)
                                ? n.replace(/a$/, 'ena')
            ...
            5571: function (e, t, n) {
                ...
                function i(e, t = !1) {
                    ...
                    if (((i += o ? r(o, !0) + ' hundrede' : ''), (n %= 100), n))
                        if (
                            ((i += i ? ' og ' : ''),
                            (o = t ? a.special.smallOrdinals[n] : a.ones[n]),
                            o)
                        )
                            i += o;
                        else {
                            const e = t
                                ? a.special.tensOrdinals[Math.floor(n / 10)]
                                : a.tens[Math.floor(n / 10)];
            ...
            166: function (e, t, n) {
                ...
                function r(e) {
                    let t = e % 1e3,
                        n = '';
                    return (
                        (n += s.ones[Math.floor(t / 100)]
                            ? s.ones[Math.floor(t / 100)] + s.numSep + 'hundred'
                            : ''),
                        (t %= 100),
                        t &&
                            ((n += n ? s.numSep : ''),
            ...
            6154: function (e, t, n) {
                ...
                (o.numericOrdinal = function (e) {
                    ...
                    (o.numberToOrdinal = function (e, t) {
                        ...
                        const n = [];
                        if ((e >= 1e3 && ((e -= 1e3), n.push('mil\xe9sima')), !e))
                            return n.join(' ');
                        let r = 0;
                        return (
                            (r = Math.floor(e / 100)),
            ...
            4394: function (e, t, n) {
                ...
                function s(e) {
                    let t = e % 1e3,
                        n = '';
                    if (
                        ((n += u.ones[Math.floor(t / 100)]
                            ? u.ones[Math.floor(t / 100)] + '-cent'
                            : ''),
                        (t %= 100),
                        t)
                    ) {
                ...
                function a(e) {
                    ...
                    if (e >= Math.pow(10, 36)) return e.toString();
                    u.special['tens-' + r.default.getInstance().subiso] &&
                ...
                const c = { 1: 'uni\xe8me', 2: 'demi', 3: 'tiers', 4: 'quart' };
                function l(e) {
                    if (1 === e) return 'premi\xe8re';
                    let t = a(e);
                    return (
                        t.match(/^neuf$/)
                            ? (t = t.slice(0, -1) + 'v')
            ...
            1779: function (e, t, n) {
                ...
                function i(e) {
                    ...
                    const r = (function (e) {
                        ...
                        return (
                            (n += s.ones[Math.floor(t / 100)]
                                ? s.ones[Math.floor(t / 100)] + s.numSep + s.special.hundred
                                : ''),
                            (t %= 100),
                    ...
                    for (; e > 0; ) {
                        const r = e % 100;
                        r && (n = s.ones[r] + s.numSep + s.large[t] + (n ? s.numSep + n : '')),
                            (e = Math.floor(e / 100)),
                            t++;
                    }
                ...
                function o(e) {
                    ...
                    if (e < 10)
                        return 'f' === t
                            ? s.special.ordinalsFeminine[e]
                            : s.special.ordinalsMasculine[e];
            ...
            5952: function (e, t, n) {
                ...
                function i(e) {
                    let t = e % 1e3,
                        n = '';
                    if (
                        ((n += a.ones[Math.floor(t / 100)]
                            ? a.ones[Math.floor(t / 100)] + a.numSep + 'cento'
                            : ''),
                        (t %= 100),
                        t)
                    ) {
                        ...
                        if (e) n += e;
                            ...
                            const r = t % 10;
                            (1 !== r && 8 !== r) || (e = e.slice(0, -1)),
                                (n += e),
                                (n += r ? a.numSep + a.ones[t % 10] : '');
                        }
                    }
                    return n;
                }
                ...
                function i(e, t = !1) {
                    ...
                    if (((r += s ? (1 === i ? '' : s) + 'hundre' : ''), (n %= 100), n)) {
                        if (((r += r ? 'og' : ''), t)) {
                            ...
                            if (n % 10)
                                return (
                                    r + a.tens[Math.floor(n / 10)] + a.special.smallOrdinals[n % 10]
                                );
                        }
                        r +=
                            a.ones[n] ||
                            a.tens[Math.floor(n / 10)] + (n % 10 ? a.ones[n % 10] : '');
                    }
                    return t ? o(r) : r;
                }
                function o(e) {
                ...
                function o(e) {
                    ...
                    return (
                        t.match(/^noll$/)
                            ? (t = 'nollte')
                            : t.match(/ett$/)
                              ? (t = t.replace(/ett$/, 'f\xf6rsta'))
                              : t.match(/tv\xe5$/)
                                ? (t = t.replace(/tv\xe5$/, 'andra'))
                                : t.match(/tre$/)
                                  ? (t = t.replace(/tre$/, 'tredje'))
                                  : t.match(/fyra$/)
                                    ? (t = t.replace(/fyra$/, 'fj\xe4rde'))
                                    : t.match(/fem$/)
                                      ? (t = t.replace(/fem$/, 'femte'))
                                      : t.match(/sex$/)
                                        ? (t = t.replace(/sex$/, 'sj\xe4tte'))
                                        : t.match(/sju$/)
                                          ? (t = t.replace(/sju$/, 'sjunde'))
                                          : t.match(/\xe5tta$/)
                                            ? (t = t.replace(/\xe5tta$/, '\xe5ttonde'))
                                            : t.match(/nio$/)
            ...
            9385: function (e, t) {
                function n(e, t = '') {
                    ...
                    const n = e.childNodes[0].childNodes[1].textContent,
                        ...
                        i = Number(n),
                        o = Number(r);
                    return isNaN(i) || isNaN(o)
                        ? { convertible: !1, content: `${r} ${t} ${n}` }
                        : { convertible: !0, enumerator: o, denominator: i };
                }
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.vulgarFractionSmall =
                        t.convertVulgarFraction =
                        t.Combiners =
                        t.siCombiner =
            ...
            1970: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.Condition = t.BaseRuleStore = void 0);
                const r = n(4148),
                    i = n(8310),
                    o = n(7039),
                    s = n(443);
                class a {
                    ...
                    static comparePreconditions_(e, t) {
                        ...
                        return (
                            n.query === r.query &&
                            a.compareStaticConstraints_(n.constraints, r.constraints)
                        );
                    }
                    defineRule(e, t, n, r, ...i) {
                        const s = this.parseAction(n),
                            ...
                            c = this.parseCstr(t);
                        if (!(s && a && c))
                            return console.error(`Rule Error: ${r}, (${t}): ${n}`), null;
                    ...
                    evaluateDefault(e) {
                        ...
                        return t.match(/^\s+$/)
                            ? this.evaluateWhitespace(t)
                            : this.evaluateString(t);
                    }
                    ...
                    evaluateCharacter(e) {
                        return (
                            this.evaluateCustom(e) ||
                            r.AuditoryDescription.create({ text: e }, { adjust: !0, translate: !0 })
                        );
                    }
                    removeDuplicates(e) {
                        for (
                            let t, n = this.speechRules_.length - 1;
                            (t = this.speechRules_[n]);
                            n--
                        )
                            t !== e &&
                                e.dynamicCstr.equal(t.dynamicCstr) &&
                                a.comparePreconditions_(t, e) &&
                                this.speechRules_.splice(n, 1);
                    }
                    getSpeechRules() {
                    ...
                    parse(e) {
                        (this.modality = e.modality || this.modality),
                            ...
                            'actions' !== e.kind &&
                                ((this.kind = e.kind || this.kind), this.inheritRules()),
                    ...
                    defineAction(e, t) {
                        ...
                        try {
                            ...
                            if ('RuleError' === e.name)
                                return void console.error('Action Error ', t, e.message);
                            throw e;
                        }
                        const r = this.getFullPreconditions(e);
                        if (!r)
                            return void console.error(
                                `Action Error: No precondition for action ${e}`,
                            );
                        this.ignoreRules(e);
                    ...
                    definePrecondition(e, t, n, ...r) {
                        const i = this.parsePrecondition(n, r),
                            o = this.parseCstr(t);
                        i && o
                            ? ((i.rank = this.rank++), this.preconditions.set(e, new c(o, i)))
                            : console.error(`Precondition Error: ${n}, (${t})`);
                    }
                    inheritRules() {
                    ...
                    ignoreRules(e, ...t) {
                        ...
                        for (const e of t) {
                            ...
                            for (const e of n)
                                t.equal(e.dynamicCstr) ? this.deleteRule(e) : r.push(e);
                            (n = r), (r = []);
                        }
                    }
                ...
                class c {
                    ...
                    addCondition(e, t) {
                        ...
                        this.allCstr.condStr ||
                            ((this.allCstr[n] = !0), this._conditions.push([e, t]));
                    }
                }
                t.Condition = c;
            },
            1462: function (e, t, n) {
                ...
                class o extends i.MathStore {
                    ...
                    annotations() {
                        for (let e, t = 0; (e = this.annotators[t]); t++)
                            (0, r.activate)(this.locale, e);
                    }
                }
                t.BrailleStore = o;
            },
            8310: function (e, t) {
                ...
                class r {
                    ...
                    static createProp(...e) {
                        const t = i.DEFAULT_ORDER,
                            n = {};
                        for (let r = 0, i = e.length, o = t.length; r < i && r < o; r++)
                            n[t[r]] = e[r];
                        return new r(n);
                    }
                    getProperties() {
                    ...
                    toString() {
                        ...
                        return (
                            this.order.forEach((t) =>
                                e.push(t + ': ' + this.getProperty(t).toString()),
                            ),
                            e.join('\n')
                        );
                    }
                ...
                t.DynamicCstrParser = class {
                    ...
                    parse(e) {
                        const t = e.split('.'),
                            n = {};
                        if (t.length > this.order.length)
                            throw new Error('Invalid dynamic constraint: ' + n);
                        let r = 0;
                ...
                t.DefaultComparator = class {
                    ...
                    setReference(e, t) {
                        (this.reference = e),
                            (this.fallback = t || new r(e.getProperties(), e.getOrder())),
                            (this.order = this.reference.getOrder());
                    }
                    match(e) {
                        const t = e.getAxes();
                        return (
                            ...
                            t.every((t) => {
                                ...
                                return (
                                    n === this.reference.getValue(t) ||
                                    -1 !== this.fallback.getProperty(t).indexOf(n)
                                );
                            })
                        );
                    }
            ...
            1058: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.numbersToAlpha = t.Grammar = t.ATTRIBUTE = void 0);
                const r = n(6671),
                    i = n(4886),
                    o = n(3319),
                    s = n(4524);
                ...
                class a {
                    ...
                    static translateUnit_(e) {
                        ...
                        return (
                            (t.strict = !0),
                            n &&
                                ((c = t.defaultParser.parse(o + '.plural')),
                                (l = t.evaluator(e, c))),
                            l
                                ? ((t.strict = r), l)
                                : ((c = t.defaultParser.parse(o + '.default')),
                                  ...
                                  (t.strict = r),
                                  l
                                      ? (n && (l = s.LOCALE.FUNCTIONS.plural(l)), l)
                                      : a.cleanUnit_(e))
                        );
                    }
                        ...
                        return (
                            ...
                            (e =
                                this.currentFlags.adjust || this.currentFlags.preprocess
                                    ? a.getInstance().preprocess(e)
                                    : e),
                            (this.parameters_.translate || this.currentFlags.translate) &&
                                (e = a.translateString_(e)),
                            (e =
                                this.currentFlags.adjust || this.currentFlags.correct
                                    ? a.getInstance().correct(e)
                                    : e),
                            (this.currentFlags = {}),
                            e
                        );
                ...
                (t.Grammar = a),
                    ...
                    a.getInstance().setPreprocessor('noTranslateText', function (e) {
                        return (
                            e.match(new RegExp('^[' + s.LOCALE.MESSAGES.regexp.TEXT + ']+$')) &&
                                (a.getInstance().currentFlags.translate = !1),
                            e
                        );
                    }),
            ...
            4161: function (e, t, n) {
                ...
                function f(e) {
                    for (const t of Object.keys(u)) {
                        ...
                        for (const t of Object.keys(e.mappings)) {
                            n.mappings[t] = {};
                            for (const i of Object.keys(e.mappings[t]))
                                n.mappings[t][i] = o.locales[c]().FUNCTIONS.si(r, e.mappings[t][i]);
                        }
                        b(n);
                    }
                    b(e);
                ...
                function N(e) {
                    return (
                        !(!e.locale && !e.modality) &&
                        ((c = e.locale || c), (l = e.modality || l), !0)
                    );
                }
                function E(e) {
                    let t = d[e];
                    return t
                        ? (r.Debugger.getInstance().output('Store exists! ' + e), t)
                        : ((t = new s.MathSimpleStore()), (d[e] = t), t);
                }
                function y(e, t) {
                    t && (e.category = t);
                }
                (t.defineRules = h),
                    ...
                    (t.enumerate = function (e = {}) {
                        for (const t of Object.values(d))
                            for (const [, n] of t.rules.entries())
                                for (const { cstr: t } of n) e = S(t.getValues(), e);
                        return e;
                    });
            },
            4974: function (e, t, n) {
                ...
                class o {
                    ...
                    static testDynamicConstraints_(e, t) {
                        return r.default.getInstance().strict
                            ? t.cstr.equal(e)
                            : r.default.getInstance().comparator.match(t.cstr);
                    }
                    ...
                    defineRuleFromStrings(e, t, n, i, o, s, a) {
                        ...
                        const l =
                                r.default.getInstance().parsers[i] ||
                                r.default.getInstance().defaultParser,
                    ...
                    lookupRule(e, t) {
                        ...
                        return (
                            ...
                            1 === n.length
                                ...
                                : n.length
                                  ? n.sort((e, t) =>
                                        r.default.getInstance().comparator.compare(e.cstr, t.cstr),
                                    )[0]
                                  : null
                        );
                    }
            ...
            7478: function (e, t, n) {
                ...
                class c extends s.BaseRuleStore {
                    ...
                    defineAlias(e, t, ...n) {
                        ...
                        i
                            ? i.addFullCondition(r)
                            : console.error(`Alias Error: No precondition by the name of ${e}`);
                    }
                    defineRulesAlias(e, t, ...n) {
                        ...
                        if (0 === r.length)
                            throw new a.OutputError('Rule with name ' + e + ' does not exist.');
                        const i = [];
                        r.forEach((e) => {
                            ((e) => {
                                const t = e.dynamicCstr.toString(),
                                    n = e.action.toString();
                                for (let e, r = 0; (e = i[r]); r++)
                                    if (e.action === n && e.cstr === t) return !1;
                    ...
                    defineSpecializedRule(e, t, n, r) {
                        ...
                        if (!o && r)
                            throw new a.OutputError(
                                'Rule named ' + e + ' with style ' + t + ' does not exist.',
                            );
                    ...
                    evaluateString(e) {
                        ...
                        if (n && n.length === e.length)
                            return t.push(this.evaluateCharacter(n.number)), t;
                        const o = r.removeEmpty(e.replace(/\s/g, ' ').split(' '));
                        for (let e, r = 0; (e = o[r]); r++)
                            if (1 === e.length) t.push(this.evaluateCharacter(e));
                            else if (
                                e.match(new RegExp('^[' + i.LOCALE.MESSAGES.regexp.TEXT + ']+$'))
                            )
                                t.push(this.evaluateCharacter(e));
                            else {
                                let r = e;
                                for (; r; ) {
                                    n = this.matchNumber_(r);
                                    const e = r.match(
                                        new RegExp('^[' + i.LOCALE.MESSAGES.regexp.TEXT + ']+'),
                                    );
                                    if (n)
                                        t.push(this.evaluateCharacter(n.number)),
                                            (r = r.substring(n.length));
                                    else if (e)
                                        t.push(this.evaluateCharacter(e[0])),
                                            (r = r.substring(e[0].length));
                                    else {
                                        const e = Array.from(r),
                                            n = e[0];
                                        t.push(this.evaluateCharacter(n)),
                                            (r = e.slice(1).join(''));
                                    }
                                }
                            }
                    ...
                    matchNumber_(e) {
                        ...
                        const r = n && n[0] === e;
                        if ((t && t[0] === e) || !r)
                            return t ? { number: t[0], length: t[0].length } : null;
                        return {
                            number: n[0]
                                .replace(new RegExp(c.regexp.DIGIT_GROUP, 'g'), 'X')
                                .replace(
                                    new RegExp(c.regexp.DECIMAL_MARK, 'g'),
                                    i.LOCALE.MESSAGES.regexp.DECIMAL_MARK,
                                )
                                .replace(
                                    /X/g,
                                    i.LOCALE.MESSAGES.regexp.DIGIT_GROUP.replace(/\\/g, ''),
                                ),
                            length: n[0].length,
                        };
                    }
                ...
                class a {
                    ...
                    static fromString(e) {
                        ...
                        if (n) {
                            ...
                            e.grammar && ((t.grammar = e.grammar), delete e.grammar),
                                Object.keys(e).length && (t.attributes = e);
                        }
                        return new a(t);
                    }
                    static attributesFromString(e) {
                        if ('(' !== e[0] || ')' !== e.slice(-1))
                            throw new u('Invalid attribute expression: ' + e);
                        const t = {},
                            n = d(e.slice(1, -1), ',');
                        for (let e = 0, r = n.length; e < r; e++) {
                            const r = n[e],
                    ...
                    for (; '' !== e; ) {
                        ...
                        if (-1 === i) {
                            if ((e.match(/"/g) || []).length % 2 != 0)
                                throw new u('Invalid string in expression: ' + e);
                            n.push(r + e), (r = ''), (e = '');
            ...
            6060: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.storeFactory = t.SpeechRuleEngine = void 0);
                const r = n(4148),
                    i = n(1984),
                    o = n(6671),
                    s = n(4886),
                ...
                class S {
                    ...
                    static debugSpeechRule(e, t) {
                        ...
                        i.Debugger.getInstance().output(n.query, r ? r.toString() : r),
                            n.constraints.forEach((n) =>
                                i.Debugger.getInstance().output(n, e.context.applyConstraint(t, n)),
                            );
                    }
                    static debugNamedSpeechRule(e, t) {
                        ...
                        for (let r, o = 0; (r = n[o]); o++)
                            i.Debugger.getInstance().output(
                                ...
                                e,
                                'DynamicCstr:',
                                r.dynamicCstr.toString(),
                                'number',
                                o,
                            ),
                                S.debugSpeechRule(r, t);
                    }
                    evaluateNode(e) {
                        ...
                        try {
                            ...
                            console.error('Something went wrong computing speech.'),
                                i.Debugger.getInstance().output(e);
                        }
                    ...
                    addStore(e) {
                        const t = N(e);
                        'abstract' !== t.kind &&
                            t.getSpeechRules().forEach((e) => this.trie.addRule(e)),
                            this.addEvaluator(t);
                    }
                    ...
                    getEvaluator(e, t) {
                        const n =
                            this.evaluators_[e] ||
                            this.evaluators_[h.DynamicCstr.DEFAULT_VALUES[h.Axis.LOCALE]];
                    ...
                    evaluateTree_(e) {
                        ...
                        let n;
                        i.Debugger.getInstance().output(t.mode !== a.Mode.HTTP ? e.toString() : e),
                            p.Grammar.getInstance().setAttribute(e);
                        const o = this.lookupRule(e, t.dynamicCstr);
                        if (!o)
                            return t.strict
                                ? []
                                : ((n = this.getEvaluator(t.locale, t.modality)(e)),
                                  e.attributes && this.addPersonality_(n, {}, !1, e),
                                  n);
                        ...
                        for (let t, i = 0; (t = u[i]); i++) {
                                ...
                                case m.ActionType.TEXT:
                                    {
                                        ...
                                        (s || '' === s) &&
                                            (i = Array.isArray(s)
                                                ? s.map(function (e) {
                                                      return r.AuditoryDescription.create(
                                                          {
                                                              text: e.speech,
                            ...
                            i[0] &&
                                ...
                                (a.context &&
                                    (i[0].context =
                                        l.constructString(e, a.context) + (i[0].context || '')),
                        ...
                        i &&
                            (i.match(/^begin/)
                                ...
                                : i.match(/^end/)
                                  ...
                                  : (e.unshift(
                                        new r.AuditoryDescription({
                                            text: '',
                                            layout: `begin${i}`,
                                        }),
                                    ),
                                    e.push(
                                        new r.AuditoryDescription({ text: '', layout: `end${i}` }),
                                    )));
                    }
                    addPersonality_(e, t, n, i) {
                        ...
                        for (let t, n = 0; (t = e[n]); n++)
                            this.addRelativePersonality_(t, o), this.addExternalAttributes_(t, i);
                        if (
                            (n &&
                                e.length &&
                                delete e[e.length - 1].personality[a.personalityProps.JOIN],
                            s && e.length)
                        ) {
                    ...
                    addRelativePersonality_(e, t) {
                        ...
                        for (const e in t)
                            n[e] && 'number' == typeof n[e] && 'number' == typeof t[e]
                                ? (n[e] = n[e] + t[e])
                                : n[e] || (n[e] = t[e]);
                        return e;
                    }
                    updateConstraint_() {
                        ...
                        n.hasSubtrie([i, o, a]) ||
                            ...
                            n.hasSubtrie([i, o, a]) ||
                                ...
                                n.hasSubtrie([i, o, a]) ||
                                    (i = h.DynamicCstr.DEFAULT_VALUES[h.Axis.LOCALE]))),
                            (r[h.Axis.LOCALE] = [i]),
                            (r[h.Axis.MODALITY] = [
                                'summary' !== o ? o : h.DynamicCstr.DEFAULT_VALUES[h.Axis.MODALITY],
                            ]),
                            (r[h.Axis.DOMAIN] = [
                                'speech' !== o ? h.DynamicCstr.DEFAULT_VALUES[h.Axis.DOMAIN] : a,
                            ]);
                        const c = e.getOrder();
                    ...
                    lookupRule(e, t) {
                        if (
                            !e ||
                            (e.nodeType !== o.NodeType.ELEMENT_NODE &&
                                e.nodeType !== o.NodeType.TEXT_NODE)
                        )
                            return null;
                    ...
                    pickMostConstraint_(e, t) {
                        ...
                        return (
                            ...
                            i.Debugger.getInstance().generateOutput(
                                (() =>
                                    t.map(
                                        (e) => e.name + '(' + e.dynamicCstr.toString() + ')',
                                    )).bind(this),
                            ),
                            t[0]
                        );
                ...
                function N(e) {
                    ...
                    u.init(),
                        e &&
                            !e.functions &&
                            (e.functions = l.getStore(e.locale, e.modality, e.domain));
                    const n = 'braille' === e.modality ? new d.BrailleStore() : new f.MathStore();
                    return (
                        b.set(t, n),
                        e.inherits &&
                            (n.inherits = b.get(`${e.inherits}.${e.modality}.${e.domain}`)),
                        n.parse(e),
                        n.initialize(),
                        n
                    );
                ...
                (t.storeFactory = N),
                    (s.default.nodeEvaluator = S.getInstance().evaluateNode.bind(S.getInstance()));
            },
            3686: function (e, t) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.CustomGenerators =
            ...
            931: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.contentIterator = t.pauseSeparator = t.nodeCounter = void 0);
                const r = n(4148),
                    i = n(5024),
                    o = n(4886);
            ...
            1939: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.getTreeFromString = t.getTree = t.xmlTree = void 0);
                const r = n(6671),
                    i = n(1784);
                function o(e) {
            ...
            4036: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.annotate = t.activate = t.register = t.visitors = t.annotators = void 0);
                const r = n(241);
                (t.annotators = new Map()),
                    (t.visitors = new Map()),
                    (t.register = function (e) {
                        const n = e.domain + ':' + e.name;
                        e instanceof r.SemanticAnnotator
                            ? t.annotators.set(n, e)
                            : t.visitors.set(n, e);
                    }),
                    ...
                    (t.annotate = function (e) {
                        ...
                        for (const n of t.visitors.values())
                            n.active && n.visit(e, Object.assign({}, n.def));
                    });
            },
            241: function (e, t) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.SemanticVisitor = t.SemanticAnnotator = void 0);
                t.SemanticAnnotator = class {
                    constructor(e, t, n) {
                        (this.domain = e), (this.name = t), (this.func = n), (this.active = !1);
                    }
                    annotate(e) {
                        e.childNodes.forEach(this.annotate.bind(this)),
                            e.addAnnotation(this.domain, this.func(e));
                    }
                };
            ...
            4020: function (e, t) {
                ...
                const fe = String.fromCodePoint(8289),
                    ...
                    be = [
                        ...
                        { set: M, type: 'identifier', role: 'latinletter', font: 'fraktur' },
                ...
                (t.equal = function (e, t) {
                    ...
                    (t.lookupType = function (e) {
                        var t;
                        return (
                            (null === (t = Ne[e]) || void 0 === t ? void 0 : t.type) || 'unknown'
                        );
                    }),
                    (t.lookupRole = function (e) {
                        var t;
                        return (
                            (null === (t = Ne[e]) || void 0 === t ? void 0 : t.role) || 'unknown'
                        );
                    }),
                    ...
                    (t.isMatchingFence = function (e, t) {
                        return -1 !== h.indexOf(e) || -1 !== p.indexOf(e)
                            ? e === t
                            : s[e] === t || a[e] === t;
                    }),
            ...
            7405: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.SemanticMeaningCollator =
                        t.SemanticNodeCollator =
                        t.SemanticDefault =
                            void 0);
                const r = n(4020),
                    i = n(178);
                ...
                class c extends s {
                    ...
                    reduce() {
                        for (const e in this.map)
                            1 !== this.map[e].length && (this.map[e] = (0, i.reduce)(this.map[e]));
                    }
                    default() {
                        const e = new o();
                        for (const t in this.map)
                            1 === this.map[t].length && (e.map[t] = this.map[t][0]);
                        return e;
                    }
                    newDefault() {
            ...
            5958: function (e, t) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.SemanticMultiHeuristic =
                        t.SemanticTreeHeuristic =
                        t.SemanticAbstractHeuristic =
                            void 0);
                class n {
            ...
            2721: function (e, t) {
                ...
                (t.flags = {
                    ...
                    (t.run = function (e, n, i) {
                        const o = r(e);
                        return o && !t.blacklist[e] && (t.flags[e] || o.applicable(n))
                            ? o.apply(n)
                            : i
                              ? i(n)
                              : n;
            ...
            7103: function (e, t, n) {
                ...
                function d(e, t, n) {
                    ...
                    if (o && s) {
                        if ('infixop' === t[0].type && 'implicit' === t[0].role)
                            return (r = e.pop()), i.push(a.postfixNode_(i.pop(), e)), r;
                        r = e.shift();
                        const n = a.prefixNode_(t.shift(), e);
                        return t.unshift(n), r;
                    }
                    return o
                        ? (i.push(a.postfixNode_(i.pop(), e)), r)
                        : (s && t.unshift(a.prefixNode_(t.shift(), e)), r);
                }
                function h(e, t, n) {
                    ...
                    if (!i)
                        return (
                            r.Debugger.getInstance().output('Juxta Heuristic Case 3'),
                            h([o].concat(a), t, n)
                        );
                    const l = a.shift();
                    if (!l) {
                    ...
                    if (c.isOperator(i) || c.isOperator(l))
                        return (
                            r.Debugger.getInstance().output('Juxta Heuristic Case 4'),
                            h(e.concat([i, o, l]).concat(a), t, n)
                        );
                    let u = null;
                    return (
                ...
                s.add(
                    ...
                    s.add(
                        new a.SemanticTreeHeuristic(
                            ...
                            (e) => (
                                'unit' !== e.role &&
                                    -1 !== ['f', 'g', 'h', 'F', 'G', 'H'].indexOf(e.textContent) &&
                                    (e.role = 'simple function'),
                                e
                            ),
                            (e) => 'clearspeak' === i.default.getInstance().domain,
                        ),
                    ...
                    s.add(
                        new a.SemanticTreeHeuristic(
                            ...
                            (e) => (
                                'fenced' === e.type &&
                                    'composed function' === e.childNodes[0].role &&
                                    (e.role = 'composed function'),
                                e
                            ),
                            (e) => 'clearspeak' === i.default.getInstance().domain,
                    ...
                    s.add(
                        new a.SemanticTreeHeuristic('multioperator', (e) => {
                            ...
                            const t = [...e.textContent].map(o.lookupMeaning).reduce(function (
                                e,
                                t,
                            ) {
                                return e && t.role && 'unknown' !== t.role && t.role !== e
                                    ? 'unknown' === e
                                        ? t.role
                                        : null
                                    : e;
                    ...
                    s.add(
                        new a.SemanticMultiHeuristic('convert_juxtaposition', (e) => {
                            let t = u.partitionNodes(e, function (e) {
                                return (
                                    e.textContent === o.invisibleTimes() && 'operator' === e.type
                                );
                            });
                            (t = t.rel.length
                                ? (function (e) {
                                      ...
                                      for (; e.comp.length; )
                                          if (((o = []), r.length))
                                              ...
                                              for (i && o.push(i); !r.length && e.comp.length; )
                                                  (r = e.comp.shift()), o.push(e.rel.shift());
                                              i = d(o, r, n);
                                          }
                                      o.length || r.length
                                          ? (t.push(i), n.push(r))
                                ...
                                : t),
                                (e = t.comp[0]);
                            for (let n, r, i = 1; (n = t.comp[i]), (r = t.rel[i - 1]); i++)
                                e.push(r), (e = e.concat(n));
                            return (
                                (t = u.partitionNodes(e, function (e) {
                                    return (
                                        e.textContent === o.invisibleTimes() &&
                                        ('operator' === e.type || 'infixop' === e.type)
                                    );
                                })),
                        ...
                        new a.SemanticTreeHeuristic(
                            ...
                            (e) => (
                                e.textContent.length > 1 &&
                                    !e.textContent[0].match(/[A-Z]/) &&
                                    (e.role = 'prefix function'),
                                e
                            ),
                            (e) =>
                                'braille' === i.default.getInstance().modality &&
                                'identifier' === e.type,
                        ),
                    ),
                    s.add(
                ...
                class c extends i.SemanticAbstractParser {
                    constructor() {
                        ...
                        [
                            ...
                            '\u211d',
                            '\u2124',
                        ].forEach(((t) => this.getFactory().defaultMap.add(t, e)).bind(this));
                    }
                    ...
                    parse(e) {
                        ...
                        return (
                            a.addAttributes(o, e),
                            -1 !== ['MATH', 'MROW', 'MPADDED', 'MSTYLE', 'SEMANTICS'].indexOf(n) ||
                                (o.mathml.unshift(e), (o.mathmlTree = e)),
                            o
                        );
                    }
                    semantics_(e, t) {
                    ...
                    rows_(e, t) {
                        ...
                        if (n && n.match('bspr_'))
                            return s.default.proof(e, n, this.parseList.bind(this));
                        let r;
                        return (
                            1 === (t = a.purgeNodes(t)).length
                                ? ((r = this.parse(t[0])),
                                  'empty' !== r.type || r.mathmlTree || (r.mathmlTree = e))
                    ...
                    fraction_(e, t) {
                        ...
                        return s.default
                            ...
                            .fractionLikeNode(
                                n,
                                r,
                                e.getAttribute('linethickness'),
                                'true' === e.getAttribute('bevelled'),
                            );
                    }
                    limits_(e, t) {
                    ...
                    text_(e, t) {
                        ...
                        return e.textContent
                            ? (n.updateContent(e.textContent, !0),
                              s.default.getInstance().text(n, r.tagName(e)))
                            : n;
                    }
                    identifier_(e, t) {
                        const n = this.leaf_(e, t);
                        return s.default
                            ...
                            .identifierNode(
                                n,
                                s.default.getInstance().font(e.getAttribute('mathvariant')),
                    ...
                    enclosed_(e, t) {
                        const n = this.parseList(a.purgeNodes(t)),
                            r = this.getFactory().makeBranchNode(
                                'enclose',
                                [s.default.getInstance().row(n)],
                                [],
                            );
                    ...
                    multiscripts_(e, t) {
                        ...
                        return a.purgeNodes(i).length || a.purgeNodes(o).length
                            ...
                            : s.default
                                  .getInstance()
                                  .pseudoTensor(n, this.parseList(l), this.parseList(c));
                    }
                    empty_(e, t) {
                    ...
                    action_(e, t) {
                        return t.length > 1
                            ? this.parse(t[1])
                            : this.getFactory().makeUnprocessed(e);
                    }
                    dummy_(e, t) {
                ...
                class s {
                    ...
                    static fromXml(e) {
                        ...
                        return (
                            ...
                            e.getAttribute('annotation') &&
                                n.parseAnnotation(e.getAttribute('annotation')),
                            o.addAttributes(n, e),
                    ...
                    querySelectorAll(e) {
                        let t = [];
                        for (let n, r = 0; (n = this.childNodes[r]); r++)
                            t = t.concat(n.querySelectorAll(e));
                        for (let n, r = 0; (n = this.contentNodes[r]); r++)
                            t = t.concat(n.querySelectorAll(e));
                    ...
                    xml(e, t) {
                        ...
                        return (
                            ...
                            this.contentNodes.length > 0 &&
                                r.appendChild(n('content', this.contentNodes)),
                            this.childNodes.length > 0 &&
                                r.appendChild(n('children', this.childNodes)),
                            r
                        );
                    }
                    toString(e = !1) {
                    ...
                    allAttributes() {
                        ...
                        return (
                            ...
                            Object.keys(this.annotation).length &&
                                e.push(['annotation', this.xmlAnnotation()]),
                    ...
                    addMathmlNodes(e) {
                        for (let t, n = 0; (t = e[n]); n++)
                            -1 === this.mathml.indexOf(t) && this.mathml.push(t);
                    }
                    appendChild(e) {
                    ...
                    appendContentNode(e) {
                        e &&
                            (this.contentNodes.push(e),
                            this.addMathmlNodes(e.mathml),
                            (e.parent = this));
                    }
                    removeContentNode(e) {
                        if (e) {
                    ...
                    equals(e) {
                        ...
                        if (
                            ...
                            return !1;
                        for (let t, n, r = 0; (t = this.childNodes[r]), (n = e.childNodes[r]); r++)
                            if (!t.equals(n)) return !1;
                        for (
                            let t, n, r = 0;
                            (t = this.contentNodes[r]), (n = e.contentNodes[r]);
                            r++
                        )
                            if (!t.equals(n)) return !1;
                        return !0;
            ...
            4790: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.SemanticNodeFactory = void 0);
                const r = n(7405),
                    i = n(7405),
                    o = n(9444);
                t.SemanticNodeFactory = class {
                    constructor() {
                        (this.leafMap = new i.SemanticNodeCollator()),
                            (this.defaultMap = new r.SemanticDefault()),
                            (this.idCounter_ = -1);
                    }
                    makeNode(e) {
                    ...
                    makeLeafNode(e, t) {
                        ...
                        return (
                            r && ((n.type = r.type), (n.role = r.role), (n.font = r.font)),
                            this.leafMap.addNode(n),
                            n
                        );
                    }
                    ...
                    createNode_(e) {
                        return (
                            void 0 !== e
                                ? (this.idCounter_ = Math.max(this.idCounter_, e))
                                : (e = ++this.idCounter_),
                            new o.SemanticNode(e)
                        );
                    }
                };
            },
            178: function (e, t) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.SemanticComparator = t.reduce = t.sort = t.apply = t.add = void 0);
                const n = [];
                function r(e) {
                    n.push(e);
                }
                ...
                class s {
                    ...
                    compare(e, t) {
                        return this.type && this.type === e.type && this.type === t.type
                            ? this.comparator(e, t)
                            : 0;
                    }
                }
            ...
            6098: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.SemanticAbstractParser = void 0);
                const r = n(4790);
                ...
                (t.isType = o),
                    ...
                    (t.isAccent = function (e) {
                        ...
                        return (
                            ...
                            (o(e, 'identifier') &&
                                a(e, 'unknown') &&
                                !e.textContent.match(r.allLettersRegExp) &&
                                !e.textContent.match(t))
                        );
                    }),
                    ...
                    (t.isEmbellished = function (e) {
                        return e.embellished
                            ? e.embellished
                            : r.isEmbellishedType(e.type)
                              ? e.type
                              : null;
                    }),
                    (t.isOperator = l),
                    ...
                    (t.lineIsLabelled = function (e) {
                        return (
                            o(e, 'line') && e.contentNodes.length && a(e.contentNodes[0], 'label')
                        );
                    }),
                    ...
                    (t.singlePunctAtPosition = function (e, t, n) {
                        return (
                            1 === t.length &&
                            ('punctuation' === e[n].type || 'punctuation' === e[n].embellished) &&
                            e[n] === t[0]
                        );
                    }),
                    ...
                    (t.isSingletonSetContent = function e(n) {
                        ...
                        return (
                            ...
                            ('fenced' === r
                                ? 'leftright' !== n.role || e(n.childNodes[0])
                                : -1 === t.scriptedElement_.indexOf(r) || e(n.childNodes[0]))
                        );
                    }),
                    (t.isNumber = b),
                    ...
                    (t.isImplicit = function (e) {
                        return (
                            ...
                            ('unit' === e.role &&
                                ...
                                e.contentNodes[0].textContent === r.invisibleTimes())
                        );
                    }),
                    ...
                    (t.compareNeutralFences = function (e, t) {
                        return (
                            N(e) &&
                            N(t) &&
                            (0, i.getEmbellishedInner)(e).textContent ===
                                (0, i.getEmbellishedInner)(t).textContent
                        );
                    }),
                        ...
                        return (
                            ...
                            (!e.embellished ||
                                ('superscript' !== e.type &&
                                    'subscript' !== e.type &&
                                    ('tensor' !== e.type ||
                                        ('empty' === e.childNodes[3].type &&
                                            'empty' === e.childNodes[4].type))))
                        );
                    }),
                    (t.elligibleRightNeutral = function (e) {
                        return (
                            ...
                            (!e.embellished ||
                                'tensor' !== e.type ||
                                ('empty' === e.childNodes[1].type &&
                                    'empty' === e.childNodes[2].type))
                        );
                    }),
                    (t.isMembership = function (e) {
                        return ['element', 'nonelement', 'reelement', 'renonelement'].includes(
                            e.role,
                        );
                    });
            },
                ...
                class l {
                    ...
                    static tableToMultiline(e) {
                        if (a.tableIsMultiline(e)) {
                            e.type = 'multiline';
                            for (let t, n = 0; (t = e.childNodes[n]); n++)
                                l.rowToLine_(t, 'multiline');
                            1 === e.childNodes.length &&
                    ...
                    static number(e) {
                        ('unknown' !== e.type && 'identifier' !== e.type) || (e.type = 'number'),
                            l.numberRole_(e),
                            l.exprFont_(e);
                    }
                        ...
                        'unknown' !== i &&
                            e.childNodes.every(function (e) {
                                ...
                                return (
                                    !t ||
                                    (t.role === i &&
                                        (a.isType(t, 'relation') || a.isType(t, 'relseq')))
                                );
                            }) &&
                            (e.role = i);
                    }
                    ...
                    static detectCaleyTable(e) {
                        ...
                        return (
                            !(!n || !r) &&
                            !(!l.cayleySpacing(n) || !l.cayleySpacing(r)) &&
                            ((e.role = 'cayley'), !0)
                        );
                    }
                    static cayleySpacing(e) {
                        const t = e.split(' ');
                        return (
                            ('solid' === t[0] || 'dashed' === t[0]) &&
                            t.slice(1).every((e) => 'none' === e)
                        );
                    }
                    static proof(e, t, n) {
                    ...
                    static getSpacer_(e) {
                        ...
                        for (; c.hasEmptyTag(e) && 1 === e.childNodes.length; )
                            if (((e = e.childNodes[0]), 'MSPACE' === r.tagName(e))) return e;
                        return null;
                    }
                    static fenceToPunct_(e) {
                        ...
                        if (t) {
                            for (; e.embellished; )
                                (e.embellished = 'punctuation'),
                                    a.isRole(e, 'subsup') ||
                                        a.isRole(e, 'underover') ||
                                        (e.role = t),
                                    (e = e.childNodes[0]);
                    ...
                    static classifyFunction_(e, t) {
                        if ('appl' === e.type || 'bigop' === e.type || 'integral' === e.type)
                            return '';
                        if (t[0] && t[0].textContent === i.functionApplication()) {
                            ...
                            return (
                                ...
                                ('prefix function' !== e.role && 'limit function' !== e.role) ||
                                    (n = e.role),
                    ...
                    static propagateFunctionRole_(e, t) {
                        if (e) {
                            ...
                            a.isRole(e, 'subsup') || a.isRole(e, 'underover') || (e.role = t),
                                l.propagateFunctionRole_(e.childNodes[0], t);
                        }
                    }
                    ...
                    static tableToMatrixOrVector_(e) {
                        const t = e.childNodes[0];
                        a.isType(t, 'multiline') ? l.tableToVector_(e) : l.tableToMatrix_(e),
                            e.contentNodes.forEach(t.appendContentNode.bind(t));
                        for (let e, n = 0; (e = t.childNodes[n]); n++)
                            l.assignRoleToRow_(e, l.getComponentRoles_(t));
                        return (t.parent = null), t;
                    }
                    static tableToVector_(e) {
                        const t = e.childNodes[0];
                        (t.type = 'vector'),
                            1 !== t.childNodes.length ? l.binomialForm_(t) : l.tableToSquare_(e);
                    }
                    static binomialForm_(e) {
                        a.isBinomial(e) &&
                            ((e.role = 'binomial'),
                            (e.childNodes[0].role = 'binomial'),
                            (e.childNodes[1].role = 'binomial'));
                    }
                    ...
                    static tableToCases_(e, t) {
                        for (let t, n = 0; (t = e.childNodes[n]); n++)
                            l.assignRoleToRow_(t, 'cases');
                        return (
                            (e.type = 'cases'),
                            e.appendContentNode(t),
                            a.tableIsMultiline(e) && l.binomialForm_(e),
                            e
                        );
                    }
                    ...
                    static numberRole_(e) {
                        ...
                        if (
                            n.every(function (e) {
                                return (
                                    ('number' === e.type && 'integer' === e.role) ||
                                    ('punctuation' === e.type && 'comma' === e.role)
                                );
                            })
                        )
                            return (
                                (e.role = 'integer'),
                                void ('0' === t[0] && e.addAnnotation('general', 'basenumber'))
                            );
                        n.every(function (e) {
                            return (
                                ('number' === e.type && 'integer' === e.role) ||
                    ...
                    static exprFont_(e) {
                        ...
                        const t = [...e.textContent].map(i.lookupMeaning).reduce(function (e, t) {
                            return e && t.font && 'unknown' !== t.font && t.font !== e
                                ? 'unknown' === e
                                    ? t.font
                                    : null
                                : e;
                    ...
                    static rewriteFence_(e, t) {
                        ...
                        return a.isType(t, 'superscript') ||
                            a.isType(t, 'subscript') ||
                            a.isType(t, 'tensor')
                            ...
                            : (t.replaceChild(n, r.fence),
                              t.mathmlTree &&
                                  -1 === t.mathml.indexOf(t.mathmlTree) &&
                                  t.mathml.push(t.mathmlTree),
                              { node: r.node, fence: t });
                    }
                    static propagateFencePointer_(e, t) {
                        (e.fencePointer = t.fencePointer || t.id.toString()),
                            (e.embellished = null);
                    }
                    static classifyByColumns_(e, t, n, r) {
                        return (
                            !!(
                                (3 === t.length &&
                                    l.testColumns_(t, 1, (e) => l.isPureRelation_(e, n))) ||
                                (2 === t.length &&
                                    (l.testColumns_(
                                        t,
                                        1,
                                        (e) => l.isEndRelation_(e, n) || l.isPureRelation_(e, n),
                                    ) ||
                                        l.testColumns_(
                                            t,
                                            0,
                                            (e) =>
                                                l.isEndRelation_(e, n, !0) ||
                                                l.isPureRelation_(e, n),
                                        )))
                            ) && ((e.role = n), !0)
                        );
                    }
                    ...
                    identifierNode(e, t, n) {
                        ...
                        return (
                            'unknown' === e.type && (e.type = 'identifier'),
                            l.exprFont_(e),
                            o.run('simpleNamedFunction', e)
                        );
                    }
                    implicitNode(e) {
                        if (
                            ((e = l.getInstance().getMixedNumbers_(e)),
                            1 === (e = l.getInstance().combineUnits_(e)).length)
                        )
                            return e[0];
                    ...
                    text(e, t) {
                        return (
                            ...
                            'MS' === t
                                ? ((e.role = 'string'), e)
                                : 'MSPACE' === t || e.textContent.match(/^\s*$/)
                                  ? ((e.role = 'space'), e)
                                  : e
                        );
                    }
                    ...
                    limitNode(e, t) {
                        ...
                        if (a.isLimitBase(r)) {
                            ...
                            if (
                                ...
                                (1 === o && a.isAccent(t[1])) ||
                                    (2 === o && a.isAccent(t[1]) && a.isAccent(t[2])))
                            )
                                return (
                                    (n = l.MML_TO_BOUNDS_[e]),
                                    l.getInstance().accentNode_(r, t, n.type, n.length, n.accent)
                                );
                            if (2 === o) {
                                if (a.isAccent(t[1]))
                                    return (
                                        (r = l
                                            ...
                                            .accentNode_(
                                                r,
                                                [r, t[1]],
                                                { MSUBSUP: 'subscript', MUNDEROVER: 'underscore' }[
                                                    e
                                                ],
                                                1,
                                                !0,
                                        ...
                                        t[2]
                                            ? l
                                                  .getInstance()
                                                  .makeLimitNode_(r, [r, t[2]], null, 'limupper')
                                            : r
                                    );
                                    ...
                                    return (
                                        (r = l
                                            ...
                                            .accentNode_(
                                                r,
                                                [r, t[2]],
                                                { MSUBSUP: 'superscript', MUNDEROVER: 'overscore' }[
                                                    e
                                                ],
                                                1,
                                                !0,
                                        ...
                                        l
                                            .getInstance()
                                            .makeLimitNode_(r, [r, t[1]], null, 'limlower')
                                    );
                                t[o] || (i = 'limlower');
                            }
                    ...
                    tablesInRow(e) {
                        ...
                        for (let e, r = 0; (e = t.rel[r]); r++)
                            (n = n.concat(t.comp.shift())), n.push(l.tableToMatrixOrVector_(e));
                        (n = n.concat(t.comp.shift())),
                            (t = c.partitionNodes(n, a.isTableOrMultiline)),
                            (n = []);
                        for (let e, r = 0; (e = t.rel[r]); r++) {
                            const r = t.comp.shift();
                            a.tableIsCases(e, r) && l.tableToCases_(e, r.pop()),
                                (n = n.concat(r)),
                                n.push(e);
                        }
                        ...
                        return e && t
                            ? l
                                  ...
                                  .horizontalFencedNode_(
                                      l.getInstance().factory_.makeContentNode(e),
                                      l.getInstance().factory_.makeContentNode(t),
                                      r,
                                  )
                    ...
                    fractionLikeNode(e, t, n, r) {
                        ...
                        if (!r && c.isZeroLength(n)) {
                            ...
                            return (
                                (i = l
                                    .getInstance()
                                    .factory_.makeBranchNode('multiline', [n, r], [])),
                                l.binomialForm_(i),
                                l.classifyMultiline(i),
                                i
                            );
                        }
                        return (
                            (i = l.getInstance().fractionNode_(e, t)),
                            r && i.addAnnotation('general', 'bevelled'),
                            i
                        );
                    }
                    tensor(e, t, n, r, i) {
                    ...
                    proof(e, t, n) {
                        if ((t.inference || t.axiom || console.log('Noise'), t.axiom)) {
                            const t = l.getInstance().cleanInference(e.childNodes),
                                r = t.length
                                    ? l.getInstance().factory_.makeBranchNode('inference', n(t), [])
                                    : l.getInstance().factory_.makeEmptyNode();
                    ...
                    inference(e, t, n) {
                        ...
                        const i = t.labelledRule,
                            ...
                            s = [];
                        ('left' !== i && 'both' !== i) ||
                            s.push(l.getInstance().getLabel(e, o, n, 'left')),
                            ('right' !== i && 'both' !== i) ||
                                s.push(l.getInstance().getLabel(e, o, n, 'right'));
                    ...
                    getFormulas(e, t, n) {
                        ...
                        return (
                            (g.mathmlTree = a.childNodes[0].childNodes[0]),
                            { conclusion: g, premises: m }
                        );
                    }
                    findNestedRow(e, t, n) {
                    ...
                    operatorNode(e) {
                        return (
                            'unknown' === e.type && (e.type = 'operator'), o.run('multioperator', e)
                        );
                    }
                    implicitNode_(e) {
                        const t = l
                            .getInstance()
                            .factory_.makeMultipleContentNodes(e.length - 1, i.invisibleTimes());
                        l.matchSpaces_(e, t);
                    ...
                    infixNode_(e, t) {
                        const n = l
                            ...
                            .factory_.makeBranchNode(
                                ...
                                e,
                                [t],
                                c.getEmbellishedInner(t).textContent,
                            );
                    ...
                    explicitMixed_(e) {
                        ...
                        for (let e, r = 0; (e = t.rel[r]); r++) {
                            ...
                            if (
                                ...
                                a.isType(i[s], 'number') &&
                                !a.isRole(i[s], 'mixed') &&
                                a.isType(o[0], 'fraction')
                            ) {
                                const e = l
                                    .getInstance()
                                    .factory_.makeBranchNode('number', [i[s], o[0]], []);
                                (e.role = 'mixed'),
                                    (n = n.concat(i.slice(0, s))),
                                    n.push(e),
                                    o.shift();
                    ...
                    combineUnits_(e) {
                        ...
                        do {
                            ...
                            (i = n.pop()),
                                ...
                                1 === e.length && (o = e.pop()),
                                e.length > 1 &&
                                    ((o = l.getInstance().implicitNode_(e)), (o.role = 'unit')),
                                o && n.push(o),
                                r && n.push(r);
                        } while (r);
                        return n;
                    ...
                    getMixedNumbers_(e) {
                        ...
                        for (let e, r = 0; (e = t.rel[r]); r++) {
                            ...
                            if (
                                i[o] &&
                                a.isType(i[o], 'number') &&
                                (a.isRole(i[o], 'integer') || a.isRole(i[o], 'float'))
                            ) {
                                const t = l
                                    .getInstance()
                                    .factory_.makeBranchNode('number', [i[o], e], []);
                        ...
                        return t.rel.some(function (e) {
                            ...
                            : ((i = l
                                  ...
                                  .factory_.makeBranchNode(
                                      ...
                                      r,
                                      t.rel,
                                      c.getEmbellishedInner(n).textContent,
                                  )),
                              (i.role = n.role),
                              i);
                    }
                    operationsInRow_(e) {
                        ...
                        const n = c.sliceNodes(e, a.isOperator),
                            r = l
                                .getInstance()
                                .prefixNode_(l.getInstance().implicitNode(n.head), t);
                    ...
                    operationsTree_(e, t, n, r) {
                        ...
                        if (0 === o.head.length)
                            return i.push(o.div), l.getInstance().operationsTree_(o.tail, t, n, i);
                        const s = l
                                .getInstance()
                                .prefixNode_(l.getInstance().implicitNode(o.head), i),
                    ...
                    appendLastOperand_(e, t, n) {
                        ...
                        for (; i && 'infixop' === i.type && !a.isImplicit(i); )
                            (r = i), (i = r.childNodes[e.childNodes.length - 1]);
                    ...
                    fences_(e, t, n, r) {
                        ...
                        if (
                            'open' === s ||
                            (a.isNeutralFence(e[0]) && (!o || !a.compareNeutralFences(e[0], o)))
                        ) {
                            n.push(e.shift());
                            const i = t.shift();
                        ...
                        if (o && 'close' === s && 'open' === o.role) {
                            const i = l
                                .getInstance()
                                .horizontalFencedNode_(n.pop(), e.shift(), r.pop());
                            return (
                                r.push(r.pop().concat([i], t.shift())),
                                l.getInstance().fences_(e, t, n, r)
                            );
                        }
                        ...
                        if (o && 'close' === s && a.isNeutralFence(o) && n.some(i)) {
                            ...
                            const d = l
                                .getInstance()
                                .horizontalFencedNode_(o.div, e.shift(), r.pop().concat(u, s));
                            return (
                                r.push(r.pop().concat([d], t.shift())),
                                l.getInstance().fences_(e, t, o.head, r)
                            );
                        }
                        const u = e.shift();
                        return (
                            l.fenceToPunct_(u),
                            r.push(r.pop().concat([u], t.shift())),
                            l.getInstance().fences_(e, t, n, r)
                        );
                    }
                    neutralFences_(e, t) {
                        ...
                        if (!a.elligibleRightNeutral(r.div))
                            return (
                                l.fenceToPunct_(r.div),
                                e.unshift(n),
                                l.getInstance().neutralFences_(e, t)
                            );
                    ...
                    horizontalFencedNode_(e, t, n) {
                        ...
                        return (
                            'open' === e.role
                                ? (l.getInstance().classifyHorizontalFence_(i),
                                  (i = o.run('propagateComposedFunction', i)))
                                : (i.role = e.role),
                    ...
                    classifyHorizontalFence_(e) {
                        ...
                        if (0 === t.length || 'empty' === t[0].type)
                            return void (e.role = 'set empty');
                        const n = t[0].type;
                        if (1 === t.length && a.isSingletonSetContent(t[0]))
                            return void (e.role = 'set singleton');
                        const r = t[0].role;
                        if ('punctuated' === n && 'sequence' === r) {
                            if ('comma' !== t[0].contentNodes[0].role)
                                return 1 !== t[0].contentNodes.length ||
                                    ('vbar' !== t[0].contentNodes[0].role &&
                                        'colon' !== t[0].contentNodes[0].role)
                                    ? void 0
                                    : ((e.role = 'set extended'),
                                      void l.getInstance().setExtension_(e));
                    ...
                    setExtension_(e) {
                        ...
                        t &&
                            ...
                            (t.addAnnotation('set', 'intensional'),
                            t.contentNodes[0].addAnnotation('set', 'intensional'));
                    }
                    ...
                    dummyNode_(e) {
                        const t = l
                            .getInstance()
                            .factory_.makeMultipleContentNodes(e.length - 1, i.invisibleComma());
                        return (
                            t.forEach(function (e) {
                                e.role = 'dummy';
                            }),
                    ...
                    accentRole_(e, t) {
                        ...
                        const n = e.textContent,
                            r =
                                i.lookupSecondary('bar', n) ||
                                i.lookupSecondary('tilde', n) ||
                                e.role;
                        return (
                            (e.role = 'underscore' === t ? 'underaccent' : 'overaccent'),
                            e.addAnnotation('accent', r),
                            !0
                        );
                    }
                    accentNode_(e, t, n, r, i) {
                        ...
                        if (
                            (!i &&
                                ...
                                ((a = l
                                    .getInstance()
                                    .factory_.makeBranchNode('subscript', [e, o], [])),
                                (a.role = 'subsup'),
                                (t = [a, s]),
                                (n = 'superscript')),
                            i)
                            ...
                            if (s) {
                                l.getInstance().accentRole_(s, 'overscore') && !r
                                    ? ((a = l
                                          .getInstance()
                                          .factory_.makeBranchNode('overscore', [e, s], [])),
                                      (t = [a, o]),
                                      (n = 'underscore'))
                                    : ((a = l
                                          .getInstance()
                                          .factory_.makeBranchNode('underscore', [e, o], [])),
                                      (t = [a, s]),
                                      (n = 'overscore')),
                                    (a.role = 'underover');
                            }
                    ...
                    makeLimitNode_(e, t, n, r) {
                        if ('limupper' === r && 'limlower' === e.type)
                            return (
                                e.childNodes.push(t[1]), (t[1].parent = e), (e.type = 'limboth'), e
                            );
                        if ('limlower' === r && 'limupper' === e.type)
                            return (
                                e.childNodes.splice(1, -1, t[1]),
                                (t[1].parent = e),
                                (e.type = 'limboth'),
                                e
                            );
                    ...
                    getFunctionArgs_(e, t, n) {
                        ...
                        switch (n) {
                            case 'integral': {
                                ...
                                if (!n.intvar && !n.integrand.length)
                                    return n.rest.unshift(e), n.rest;
                                const r = l.getInstance().row(n.integrand);
                                return (
                                    (o = l.getInstance().integralNode_(e, r, n.intvar)),
                                    n.rest.unshift(o),
                                    n.rest
                                );
                            }
                            case 'prefix':
                                if (t[0] && 'fenced' === t[0].type) {
                                    const n = t.shift();
                                    return (
                                        a.isNeutralFence(n) || (n.role = 'leftright'),
                                        (o = l.getInstance().functionNode_(e, n)),
                                        t.unshift(o),
                                        t
                                    );
                                }
                                if (
                                    ((r = c.sliceNodes(t, a.isPrefixFunctionBoundary)),
                                    r.head.length)
                                )
                                ...
                                return (
                                    (o = l.getInstance().functionNode_(e, i)),
                                    r.tail.unshift(o),
                                    r.tail
                                );
                            case 'bigop':
                            ...
                            default: {
                                if (0 === t.length) return [e];
                                const n = t[0];
                                return 'fenced' === n.type &&
                                    !a.isNeutralFence(n) &&
                                    a.isSimpleFunctionScope(n)
                                    ? ((n.role = 'leftright'),
                    ...
                    getIntegralArgs_(e, t = []) {
                        ...
                        const n = e[0];
                        if (a.isGeneralFunctionBoundary(n))
                            return { integrand: t, intvar: null, rest: e };
                        if (a.isIntegralDxBoundarySingle(n))
                            return (
                                (n.role = 'integral'), { integrand: t, intvar: n, rest: e.slice(1) }
                            );
                        if (e[1] && a.isIntegralDxBoundary(n, e[1])) {
                            const r = l.getInstance().prefixNode_(e[1], [n]);
                            return (
                                (r.role = 'integral'), { integrand: t, intvar: r, rest: e.slice(2) }
                            );
                        }
                    ...
                    functionNode_(e, t) {
                        ...
                        const o = l.getFunctionOp_(e, function (e) {
                            return (
                                a.isType(e, 'function') ||
                                (a.isType(e, 'identifier') && a.isRole(e, 'simple function'))
                            );
                        });
                    ...
                    integralNode_(e, t, n) {
                        (t = t || l.getInstance().factory_.makeEmptyNode()),
                            (n = n || l.getInstance().factory_.makeEmptyNode());
                        ...
                        for (let o, s = 0; (o = e[s]); s++) {
                            ...
                            if ('MSPACE' !== e) {
                                if ('MROW' === e)
                                    return l
                                        .getInstance()
                                        .findNestedRow_(r.toArray(o.childNodes), t, n + 1, i);
                ...
                class s {
                    ...
                    static collapsedLeafs(...e) {
                        return e.reduce((e, t) => {
                            return e.concat(
                                ((n = t),
                                s.simpleCollapseStructure(n)
                                    ? [n]
                                    : ((n = n),
                                      s.contentCollapseStructure(n[1]) ? n.slice(2) : n.slice(1))),
                            );
                            var n;
                        }, []);
                    }
                    ...
                    populate_(e, t, n) {
                        if (s.simpleCollapseStructure(e))
                            return (
                                (e = e),
                                (this.levelsMap[e] = t),
                                void (this.parents[e] = e === n[0] ? n.slice(1) : n)
                            );
                    ...
                    directChildren(e) {
                        ...
                        return this.levelsMap[e]
                            .slice(1)
                            .map((e) =>
                                s.simpleCollapseStructure(e)
                                    ? e
                                    : s.contentCollapseStructure(e)
                                      ? e[1]
                                      : e[0],
                    ...
                    subtreeNodes(e) {
                        ...
                        const t = (e, n) => {
                                s.simpleCollapseStructure(e)
                                    ? n.push(e)
                                    : ((e = e),
                                      s.contentCollapseStructure(e) && (e = e.slice(1)),
                                      e.forEach((e) => t(e, n)));
                            },
                            n = this.levelsMap[e],
                            r = [];
            ...
            1784: function (e, t, n) {
                ...
                class l {
                    constructor(e) {
                        ...
                        t &&
                            ((this.parser = new s.SemanticMathml()),
                            (this.parser.getFactory().defaultMap = t),
                            (this.root = this.parser.parse(e))),
                            u.visit(this.root, {}),
                    ...
                    static fromXml(e) {
                        const t = l.empty();
                        return (
                            e.childNodes[0] && (t.root = a.SemanticNode.fromXml(e.childNodes[0])), t
                        );
                    }
                    xml(e) {
                ...
                const u = new o.SemanticVisitor('general', 'unit', (e, t) => {
                    if (
                        'infixop' === e.type &&
                        ('multiplication' === e.role || 'implicit' === e.role)
                    ) {
                        const t = e.childNodes;
                        t.length &&
                            (c.isPureUnit(t[0]) || c.isUnitCounter(t[0])) &&
                            e.childNodes.slice(1).every(c.isPureUnit) &&
                            (e.role = 'unit');
                    }
                    return !1;
                });
            ...
            8901: function (e, t, n) {
                ...
                function o(e, t, n) {
                    ...
                    for (let i, o = 0; (i = e[o]); o++) {
                        if (t(i))
                            return n
                                ? { head: e.slice(o + 1).reverse(), div: i, tail: r.reverse() }
                                : { head: r, div: i, tail: e.slice(o + 1) };
                        r.push(i);
                    }
                    return n
                        ? { head: [], div: null, tail: r.reverse() }
                        : { head: r, div: null, tail: [] };
                }
                (t.LEAFTAGS = ['MO', 'MI', 'MN', 'MTEXT', 'MS', 'MSPACE']),
                    ...
                    (t.purgeNodes = function (e) {
                        ...
                        for (let i, o = 0; (i = e[o]); o++) {
                            ...
                            const e = r.tagName(i);
                            -1 === t.IGNORETAGS.indexOf(e) &&
                                ((-1 !== t.EMPTYTAGS.indexOf(e) && 0 === i.childNodes.length) ||
                                    n.push(i));
                        }
                        return n;
                    }),
                    ...
                    (t.addAttributes = function (e, n) {
                        if (n.hasAttributes()) {
                            ...
                            for (let n = r.length - 1; n >= 0; n--) {
                                const i = r[n].name;
                                i.match(/^ext/) &&
                                    ((e.attributes[i] = r[n].value), (e.nobreaking = !0)),
                                    -1 !== t.directSpeechKeys.indexOf(i) &&
                                        ((e.attributes['ext-speech'] = r[n].value),
                                        (e.nobreaking = !0)),
                                    i.match(/texclass$/) && (e.attributes.texclass = r[n].value),
                                    'href' === i &&
                                        ((e.attributes.href = r[n].value), (e.nobreaking = !0));
                            }
                        }
                    }),
                    (t.getEmbellishedInner = function e(t) {
                        return t && t.embellished && t.childNodes.length > 0
                            ? e(t.childNodes[0])
                            : t;
                    }),
                    (t.sliceNodes = o),
            ...
            9135: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.AbstractSpeechGenerator = void 0);
                const r = n(985),
                    i = n(8171),
                    o = n(1848),
                    s = n(144);
                t.AbstractSpeechGenerator = class {
                    constructor() {
                        (this.modality = i.addPrefix('speech')),
                            (this.rebuilt_ = null),
                            (this.options_ = {});
                    }
                    getRebuilt() {
                    ...
                    setOptions(e) {
                        (this.options_ = e || {}),
                            (this.modality = i.addPrefix(this.options_.modality || 'speech'));
                    }
                    getOptions() {
                    ...
                    generateSpeech(e, t) {
                        return (
                            this.rebuilt_ || (this.rebuilt_ = new o.RebuildStree(t)),
                            (0, r.setup)(this.options_),
            ...
            6281: function (e, t, n) {
                ...
                class c extends a.AbstractSpeechGenerator {
                    constructor() {
                        super(...arguments),
                            (this.modality = (0, r.addPrefix)('foreground')),
                            (this.contrast = new i.ContrastPicker());
                    }
                    static visitStree_(e, t, n) {
                        if (e.childNodes.length) {
                            if (
                                (e.contentNodes.length &&
                                    ('punctuated' === e.type &&
                                        e.contentNodes.forEach((e) => (n[e.id] = !0)),
                                    'implicit' !== e.role &&
                                        t.push(e.contentNodes.map((e) => e.id))),
                                e.childNodes.length)
                            ) {
                                if ('implicit' === e.role) {
                                    const r = [];
                    ...
                    generateSpeech(e, t) {
                        return (
                            this.getRebuilt() || this.setRebuilt(new o.RebuildStree(e)),
                            this.colorLeaves_(e),
                            s.getAttribute(e, this.modality)
                        );
                    }
                    colorLeaves_(e) {
                        const t = [];
            ...
            1565: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.DirectSpeechGenerator = void 0);
                const r = n(8835),
                    i = n(9135);
            ...
            7317: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.generatorMapping_ = t.generator = void 0);
                const r = n(3153),
                    i = n(6281),
                    o = n(1565),
                    s = n(7721),
                ...
                function m(e, t) {
                    ...
                    const i = function (e, t) {
                        for (
                            ;
                            t.length &&
                            t.shift().toString() === e.getAttribute('id') &&
                            e.parentNode &&
                ...
                (t.computeSpeech = u),
                    ...
                    (t.connectMactions = function (e, t, n) {
                        ...
                        for (let t, o = 0; (t = r[o]); o++) {
                            ...
                            if (((u = o.childNodes[0]), u.getAttribute('sre-highlighter-added')))
                                continue;
                            const d = a.getAttribute(s.Attribute.PARENT);
                            d && u.setAttribute(s.Attribute.PARENT, d),
                                u.setAttribute(s.Attribute.TYPE, 'dummy'),
                                u.setAttribute(s.Attribute.ID, c);
                            i.querySelectorAllByAttrValue(n, 'id', c)[0].setAttribute(
                                'alternative',
                                c,
                            );
                        }
                    ...
                    (t.connectAllMactions = function (e, t) {
                        ...
                        for (let e, r = 0; (e = n[r]); r++) {
                            ...
                            i.querySelectorAllByAttrValue(t, 'id', n)[0].setAttribute(
                                'alternative',
                                n,
                            );
                        }
            ...
            5778: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.SummarySpeechGenerator = void 0);
                const r = n(9135),
                    i = n(144);
                class o extends r.AbstractSpeechGenerator {
                    getSpeech(e, t) {
                        return (
                            i.connectAllMactions(t, this.getRebuilt().xml),
                            this.generateSpeech(e, t)
                        );
                    }
                }
            ...
            650: function (e, t, n) {
                ...
                function d() {
                    const e = o.LOCALE.ALPHABETS,
                        n = (e, t) => {
                            const n = {};
                            return (
                                Object.keys(e).forEach((e) => (n[e] = !0)),
                                Object.keys(t).forEach((e) => (n[e] = !0)),
                                Object.keys(n)
                            );
                        };
                ...
                function f(e) {
                    const t =
                        'normal' === e || 'fullwidth' === e
                            ? ''
                            : o.LOCALE.MESSAGES.font[e] || o.LOCALE.MESSAGES.embellish[e] || '';
                ...
                !(function (e) {
                    ...
                    (t.generate = function (e) {
                        ...
                        (r.default.getInstance().locale = e),
                            i.setLocale(),
                            a.addSymbolRules({ locale: e }),
                            d();
                        const s = t.INTERVALS;
            ...
            3955: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.Parser = t.Comparator = t.ClearspeakPreferences = void 0);
                const r = n(4886),
                    i = n(4998),
                    o = n(8310),
                    s = n(8310),
                ...
                class l extends o.DynamicCstr {
                        ...
                        return [
                            ...
                            n[o].map(function (e) {
                                ...
                                return {
                                    type: 'radio',
                                    content: t[1],
                                    id: 'clearspeak-' + l.addPreference(s, t[0], t[1]),
                                    variable: 'speechRules',
                                };
                            }),
                        );
                    ...
                    static getLocalePreferences_(e) {
                        ...
                        for (const n in e) {
                            ...
                            for (const e in u.getProperties()) {
                                ...
                                if (t)
                                    for (const i of t)
                                        -1 !== r.indexOf(e + '_' + i) && n.push(e + '_' + i);
                                i[e] = n;
                            }
                        }
                        return t;
                    ...
                    equal(e) {
                        ...
                        for (let e, r = 0; (e = t[r]); r++)
                            if (this.preference[e] !== n[e]) return !1;
                        return !0;
                    }
                }
                ...
                class d extends s.DefaultComparator {
                    ...
                    match(e) {
                        ...
                        for (let n, r = 0; (n = t[r]); r++)
                            if (this.preference[n] !== e.preference[n]) return !1;
                        return !0;
                    }
                    compare(e, t) {
                ...
                class h extends s.DynamicCstrParser {
                    ...
                    parse(e) {
                        ...
                        let a = {};
                        return (
                            n !== o.DynamicCstr.DEFAULT_VALUE &&
                                ((a = this.fromPreference(n)), (n = this.toPreference(a))),
                ...
                (r.default.getInstance().comparators.clearspeak = l.comparator),
                    (r.default.getInstance().parsers.clearspeak = new h());
            },
            127: function (e, t, n) {
            ...
            8662: function (e, t, n) {
                ...
                function f(e) {
                    return (
                        'appl' === e.type &&
                        ('prefix function' === e.childNodes[0].role ||
                            'simple function' === e.childNodes[0].role) &&
                        (b(e.childNodes[1]) ||
                            ('fenced' === e.childNodes[1].type && b(e.childNodes[1].childNodes[0])))
                    );
                }
                function m(e) {
                    return (
                ...
                function S(e) {
                    return (
                        ...
                        ('infixop' === e.type &&
                            'implicit' === e.role &&
                            ((2 === e.childNodes.length &&
                                (N(e.childNodes[0]) || y(e.childNodes[0])) &&
                                N(e.childNodes[1])) ||
                ...
                function v(e) {
                    return (
                        'number' === e.tagName &&
                        e.hasAttribute('role') &&
                        'integer' === e.getAttribute('role')
                    );
                }
                function O(e) {
                    return o
                        .evalXPath('children/*', e)
                        .every((e) => v(e) || 'identifier' === e.tagName);
                }
                function M(e) {
                    return (
                        'text' === e.type ||
                ...
                function I(e) {
                    for (let t = 0; t < e.length - 1; t++)
                        if ('text' !== e[t].type || '' !== e[t].textContent) return !1;
                ...
                function x(e) {
                    return (
                        e &&
                        ('fenced' === e.tagName ||
                            (e.hasAttribute('role') && 'leftright' === e.getAttribute('role')) ||
                            P(e))
                    );
                }
                function P(e) {
                ...
                (t.nodeCounter = function (e, t) {
                    ...
                    (t.ordinalExponent = function (e) {
                        ...
                        return isNaN(t)
                            ? e.textContent
                            : t > 10
                              ? s.LOCALE.NUMBERS.numericOrdinal(t)
                              : s.LOCALE.NUMBERS.wordOrdinal(t);
                    }),
                    ...
                    (t.nestingDepth = function (e) {
                        ...
                        for (; o; )
                            'fenced' === o.tagName &&
                                o.childNodes[0].childNodes[i].textContent === r &&
                                n++,
                                (o = o.parentNode);
                        return (
                            (t.NESTING_DEPTH = n > 1 ? s.LOCALE.NUMBERS.wordOrdinal(n) : ''),
                            t.NESTING_DEPTH
                        );
                    }),
                    (t.matchingFences = function (e) {
                        ...
                        let n, r;
                        return (
                            t ? ((n = t), (r = e)) : ((n = e), (r = e.nextSibling)),
                            r && (0, h.isMatchingFence)(n.textContent, r.textContent) ? [e] : []
                        );
                    }),
                    (t.insertNesting = L),
                            ...
                            (R(n[i + 1]) ||
                                ...
                                ('superscript' === n[i + 1].tagName &&
                                    ...
                                    ('number' === n[i + 1].childNodes[0].childNodes[0].tagName ||
                                        'identifier' ===
                                            n[i + 1].childNodes[0].childNodes[0].tagName) &&
                                    ('2' === n[i + 1].childNodes[0].childNodes[1].textContent ||
                                        '3' === n[i + 1].childNodes[0].childNodes[1].textContent)))
                            ? [e]
                            : [];
                    }),
                    (t.simpleFactor_ = R),
            ...
            5659: function (e, t, n) {
                ...
                function g(e = o.default.getInstance().locale) {
                    o.EnginePromise.loaded[e] ||
                        ...
                        (function (e) {
                            if (
                                o.default.getInstance().isIE &&
                                o.default.getInstance().mode === s.Mode.HTTP
                            )
                                return void y(e);
                            b(e);
                        })(e));
                ...
                function b(e) {
                    const t = o.default.getInstance().customLoader
                            ...
                            t(e).then(
                                ...
                                (t) => {
                                    (o.EnginePromise.loaded[e] = [!0, !1]),
                                        ...
                                        (o.default.getInstance().locale =
                                            o.default.getInstance().defaultLocale),
                                        n(e);
                                },
                            );
                        });
                ...
                function y(e, t) {
                    ...
                    i.mapsForIE
                        ? E(i.mapsForIE, e)
                        : n <= 5 && setTimeout((() => y(e, n++)).bind(this), 300);
                }
                function A(e) {
            ...
            4972: function (e, t, n) {
                ...
                t.MathspeakRules = function () {
                    c.addStore(r.DynamicCstr.BASE_LOCALE + '.speech.mathspeak', '', {
                        ...
                        c.addStore(
                            'es.speech.mathspeak',
                            r.DynamicCstr.BASE_LOCALE + '.speech.mathspeak',
                            { CTFunitMultipliers: l.unitMultipliers, CQFoneLeft: l.oneLeft },
                        ),
                        c.addStore(
                            'fr.speech.mathspeak',
                            r.DynamicCstr.BASE_LOCALE + '.speech.mathspeak',
            ...
            3269: function (e, t, n) {
                    ...
                    return (
                        ...
                        1 === r
                            ...
                            : s.LOCALE.FUNCTIONS.combineNestedRadical(
                                  t,
                                  s.LOCALE.FUNCTIONS.radicalNestDepth(r - 1),
                                  n,
                              )
                    );
                }
                function b(e) {
                    const t =
                        'sqrt' === e.tagName
                            ? '2'
                            : o.evalXPath('children/*[1]', e)[0].textContent.trim();
                ...
                function N(e) {
                    return u('underscore', e, ['underscore'], t.nestingBarriers, {}, function (e) {
                        return (
                            e.tagName &&
                            'underscore' === e.tagName &&
                            'underaccent' === e.childNodes[0].childNodes[1].getAttribute('role')
                        );
                    });
                }
                function E(e) {
                    return u('overscore', e, ['overscore'], t.nestingBarriers, {}, function (e) {
                        return (
                            e.tagName &&
                            'overscore' === e.tagName &&
                            'overaccent' === e.childNodes[0].childNodes[1].getAttribute('role')
                        );
                    });
                }
                (t.spaceoutText = function (e) {
                    ...
                    (t.baselineVerbose = function (e) {
                        ...
                        return t
                            ? t
                                  .replace(
                                      new RegExp(s.LOCALE.MESSAGES.MS.SUB + '$'),
                                      s.LOCALE.MESSAGES.MS.SUBSCRIPT,
                                  )
                                  .replace(
                                      new RegExp(s.LOCALE.MESSAGES.MS.SUPER + '$'),
                    ...
                    (t.nestedUnderscript = function (e) {
                        const t = N(e);
                        return (
                            Array(t).join(s.LOCALE.MESSAGES.MS.UNDER) +
                    ...
                    (t.nestedOverscript = function (e) {
                        const t = E(e);
                        return (
                            Array(t).join(s.LOCALE.MESSAGES.MS.OVER) +
                            s.LOCALE.MESSAGES.MS.OVERSCRIPT
                        );
                    }),
                    (t.determinantIsSimple = function (e) {
                        if ('matrix' !== e.tagName || 'determinant' !== e.getAttribute('role'))
                            return [];
                    ...
                    (t.generateBaselineConstraint = function () {
                        ...
                        return [
                            ['ancestor::*/following-sibling::*', n, t(o.join(' | '))].join(' and '),
                        ];
                    }),
                    (t.removeParens = function (e) {
                        if (
                            ...
                            !e.childNodes[0].childNodes[0].childNodes.length
                        )
                            return '';
                ...
                (t.generateTensorRules = function (e, t = !0) {
                    ...
                    for (let r, i = 0; (r = n[i]); i++) {
                        ...
                        e.defineRule(n, 'default', o, 'self::tensor', ...i),
                            t &&
                                (e.defineRule(n, 'brief', s, 'self::tensor', ...i),
                                e.defineRule(n, 'sbrief', s, 'self::tensor', ...i));
                        const a = y.get(2);
                        (o += '; [t]' + a + 'Verbose'),
                            (s += '; [t]' + a + 'Brief'),
                            (n += '-baseline');
                        ...
                        e.defineRule(n, 'default', o, 'self::tensor', c, ...i),
                            t &&
                                (e.defineRule(n, 'brief', s, 'self::tensor', c, ...i),
                                e.defineRule(n, 'sbrief', s, 'self::tensor', c, ...i));
                    }
                }),
            ...
            9570: function (e, t, n) {
                ...
                function p(e, t) {
                    const n = t || 0;
                    return e.parentNode
                        ? p(e.parentNode, 'root' === e.tagName || 'sqrt' === e.tagName ? n + 1 : n)
                        : n;
                }
                function f(e) {
                    const t = '\u2820';
                ...
                function g(e, n) {
                    return e.childNodes.length
                        ...
                        : (m(e, n) && ((n.number = !0), (n.script = !1), (n.enclosed = !1)),
                          [
                              n.number ? 'number' : '',
                              { number: !1, enclosed: n.enclosed, script: n.script },
                          ]);
                }
                (t.openingFraction = function (e) {
                    const t = d.fractionNestingDepth(e);
                    return (
                        new Array(t).join(u.LOCALE.MESSAGES.MS.FRACTION_REPEAT) +
                            ...
                            function () {
                                ...
                                const p = o
                                    ...
                                    f =
                                        ...
                                        (c &&
                                            e.parentNode.parentNode &&
                                            e.parentNode.parentNode.previousSibling)
                                            ? [
                                                  r.AuditoryDescription.create(
                                                      { text: '\u2800' + p },
                                                      {},
                    ...
                    (t.vulgarFraction = function (e) {
                        ...
                        return t.convertible && t.enumerator && t.denominator
                            ? [
                                  ...
                                  new r.Span(
                                      o.LOCALE.NUMBERS.numberToOrdinal(
                                          t.denominator,
                                          1 !== t.enumerator,
                                      ),
                                      {
                                          extid: e.childNodes[0].childNodes[1].getAttribute(
                                              'extid',
                                          ),
                                      },
                                  ),
            ...
            3724: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.BrailleRules = t.OtherRules = t.PrefixRules = void 0);
                const r = n(8310),
                    i = n(931),
                    o = n(3269),
                    s = n(9570),
                ...
                (t.PrefixRules = function () {
                    ...
                    (t.OtherRules = function () {
                        c.addStore('en.speech.chromevox', '', {
            ...
            7278: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.getStore = t.addStore = t.funcStore = void 0);
                const r = n(8310);
                (t.funcStore = new Map()),
                    ...
                    (t.getStore = function (e, n, i) {
                        return (
                            ...
                            t.funcStore.get(
                                [r.DynamicCstr.DEFAULT_VALUES[r.Axis.LOCALE], n, i].join('.'),
                            ) ||
            ...
            9771: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.oneLeft = t.leftMostUnit = t.rightMostUnit = t.unitMultipliers = void 0);
                const r = n(4148),
                    i = n(5024),
                    o = n(4524);
                t.unitMultipliers = function (e, t) {
                    ...
                    let i = 0;
                    return function () {
                        const e = r.AuditoryDescription.create(
                            { text: a(n[i]) && c(n[i + 1]) ? o.LOCALE.MESSAGES.unitTimes : '' },
                            {},
                        );
                        return i++, [e];
                    };
                ...
                (t.rightMostUnit = a),
                    ...
                    (t.oneLeft = function (e) {
                        for (; e; ) {
                            ...
                            if (
                                'infixop' !== e.tagName ||
                                ('multiplication' !== e.getAttribute('role') &&
                                    'implicit' !== e.getAttribute('role'))
                            )
                                return [];
                            e = i.evalXPath('children/*', e)[0];
                        }
            ...
            4660: function (e, t, n) {
                ...
                class y {
                        ...
                        (this.node = e),
                            ...
                            this.node.id
                                ...
                                : this.node.hasAttribute(y.SRE_ID_ATTR)
                                  ...
                                  : (this.node.setAttribute(y.SRE_ID_ATTR, y.ID_COUNTER.toString()),
                                    (this.id = y.ID_COUNTER++)),
                    ...
                    getFocus(e = !1) {
                        return (
                            this.focus_ || (this.focus_ = this.singletonFocus(this.rootId)),
                            e && this.updateFocus(),
                            this.focus_
                        );
                    }
                        ...
                        switch (this.moved) {
                            ...
                            default: {
                                ...
                                for (let r = 0, i = e.length; r < i; r++) {
                                    ...
                                    t.push(
                                        i
                                            ? this.generator.getSpeech(i, this.getXml())
                                            : f.recomputeMarkup(o),
                                    );
                                }
                    ...
                    move(e) {
                        ...
                        return (
                            !(!n || n === this.getFocus()) &&
                            (this.setFocus(n),
                            this.moved === b.WalkerMoves.HOME && (this.levels = this.initLevels()),
                            !0)
                        );
                    }
                    up() {
                    ...
                    previousLevel() {
                        const e = this.getFocus().getDomPrimary();
                        return e
                            ? N.getAttribute(e, l.Attribute.PARENT)
                    ...
                    retrieveVisuals(e) {
                        ...
                        for (const e of n)
                            r[e] || (i.push(e.toString()), (r[e] = !0), this.subtreeIds(e, r));
                        return i;
                    }
                    subtreeIds(e, t) {
                        const n = E.evalXPath(`//*[@data-semantic-id="${e}"]`, this.getXml());
                        E.evalXPath('*//@data-semantic-id', n[0]).forEach(
                            (e) => (t[parseInt(e.textContent, 10)] = !0),
                        );
                    }
                    focusFromId(e, t) {
                    ...
                    update(e) {
                        this.generator.setOptions(e),
                            (0, a.setup)(e).then(() =>
                                p.generator('Tree').getSpeech(this.node, this.getXml()),
                            );
                    }
                    nextRules() {
                    ...
                    nextStyle(e, t) {
                        ...
                        if ('clearspeak' === e) {
                            ...
                            if (!e) return 'default';
                            const n = m.ClearspeakPreferences.relevantPreferences(
                    ...
                    prefix_() {
                        ...
                        return e[0]
                            ? N.getAttribute(e[0], l.Attribute.PREFIX)
                            : f.retrievePrefix(t[0]);
                    }
                    postfix_() {
                        const e = this.getFocus().getDomNodes();
                    ...
                    depth_() {
                        ...
                        return (
                            d.Grammar.getInstance().setParameter('depth', e),
                            i.finalize(i.markup(c))
                        );
                    }
                    actionable_(e) {
                ...
                class i {
                    ...
                    static factory(e, t, n, o) {
                        ...
                        return (
                            (d.domNodes = l),
                            (d.domPrimary_ = c),
                            (d.allNodes = i.generateAllVisibleNodes_(t, l, a, o)),
                            d
                        );
                    }
                    ...
                    clone() {
                        ...
                        return (
                            (e.domNodes = this.domNodes),
                            (e.domPrimary_ = this.domPrimary_),
                            (e.allNodes = this.allNodes),
                            e
                        );
                    }
                }
            ...
            1848: function (e, t, n) {
                ...
                class h {
                    ...
                    static addAttributes(e, t, n) {
                        n &&
                            1 === t.childNodes.length &&
                            t.childNodes[0].nodeType !== r.NodeType.TEXT_NODE &&
                            u.addAttributes(e, t.childNodes[0]),
                            u.addAttributes(e, t);
                    }
                    ...
                    static isPunctuated(e) {
                        return (
                            !c.SemanticSkeleton.simpleCollapseStructure(e) &&
                            e[1] &&
                            c.SemanticSkeleton.contentCollapseStructure(e[1])
                        );
                    }
                    getTree() {
                        return this.stree;
                    ...
                    assembleTree(e) {
                        ...
                        if (
                            (h.addAttributes(t, e, !(n.length || r.length)),
                            0 === r.length && 0 === n.length)
                        )
                            return h.textContent(t, e), t;
                        if (r.length > 0) {
                            const e = d.getBySemanticId(this.mathml, r[0]);
                            e && h.textContent(t, e, !0);
                        }
                        (t.contentNodes = r.map((e) => this.setParent(e, t))),
                            (t.childNodes = n.map((e) => this.setParent(e, t)));
                    ...
                    makePunctuated(e, t, n) {
                        ...
                        (r.type = 'punctuated'),
                            (r.embellished = e.embellished),
                            (r.fencePointer = e.fencePointer),
                            (r.role = n);
                        const i = t.splice(1, 1)[0].slice(1);
                        (r.contentNodes = i.map(this.makePunctuation.bind(this))),
                            this.collapsedChildren_(t);
                    }
                    makeEmpty(e, t, n) {
                    ...
                    makeIndex(e, t, n) {
                        ...
                        c.SemanticSkeleton.simpleCollapseStructure(t) &&
                            !this.nodeDict[t.toString()] &&
                            this.makeEmpty(e, t, n);
                    }
                    postProcess(e, t) {
                        ...
                        if ('subscript' === e.type)
                            return (
                                this.makeIndex(e, n[2], 'rightsub'), this.collapsedChildren_(n), e
                            );
                        if ('superscript' === e.type)
                            return (
                                this.makeIndex(e, n[2], 'rightsuper'), this.collapsedChildren_(n), e
                            );
                        if ('tensor' === e.type)
                            return (
                    ...
                    collapsedChildren_(e) {
                        const t = (e) => {
                            ...
                            for (let r = 1, i = e.length; r < i; r++) {
                                const i = e[r];
                                n.childNodes.push(
                                    c.SemanticSkeleton.simpleCollapseStructure(i)
                                        ? this.nodeDict[i]
                                        : t(i),
                                );
                            }
                ...
                class o extends r.AbstractWalker {
                    ...
                    combineContentChildren(e, t, n, r) {
                        switch (e) {
                            ...
                            case 'appl':
                                return [
                                    this.focusFromId(r[0], [r[0], n[0]]),
                                    this.singletonFocus(r[1]),
                                ];
                            case 'root':
                        ...
                        return i === o
                            ...
                            : (t.unshift(o),
                              ...
                              e.length === t.length
                                  ...
                                  : (r.push(this.focusFromId(i, n)),
                                    this.combinePunctuations(e, t, [], r)));
                    }
                    makePairList(e, t) {
                        ...
                        for (let r = 0, i = e.length; r < i; r++)
                            n.push(this.focusFromId(e[r], [t[r], e[r]]));
                        return n;
                    }
                    left() {
                        super.left();
                ...
                class a extends o.SyntaxWalker {
                    ...
                    up() {
                        return (
                            ...
                            this.eligibleCell_() ? this.verticalMove_(!1) : super.up()
                        );
                    }
                    down() {
                        return (
                            (this.moved = s.WalkerMoves.DOWN),
                            this.eligibleCell_() ? this.verticalMove_(!0) : super.down()
                        );
                    }
                    jumpCell() {
                        ...
                        if (this.moved === s.WalkerMoves.ROW) {
                            ...
                            return this.isLegalJump_(this.row_, e)
                                ? this.jumpCell_(this.row_, e)
                                : this.getFocus();
                        }
                        const e = this.key_ - i.KeyCode.ZERO;
                    ...
                    eligibleCell_() {
                        ...
                        return (
                            this.modifier &&
                            'cell' === e.type &&
                            -1 !== a.ELIGIBLE_CELL_ROLES.indexOf(e.role)
                        );
                    }
                    verticalMove_(e) {
                        ...
                        return a[r]
                            ? (this.levels.push(a), this.singletonFocus(a[r]))
                            : (this.setFocus(n), this.levels.push(i), null);
                    }
                    jumpCell_(e, t) {
                        this.firstJump
                            ? this.virtualize(!1)
                        ...
                        this.levels.push(r),
                            this.setFocus(this.singletonFocus(n)),
                    ...
                    isLegalJump_(e, t) {
                        const n = r.querySelectorAllByAttrValue(
                            this.getRebuilt().xml,
                            'id',
                        ...
                        return (
                            !(!o || o.hasAttribute('alternative')) && !(!i || !i.childNodes[t - 1])
                        );
                    }
                    isInTable_() {
                        let e = this.getFocus().getSemanticPrimary();
                        for (; e; ) {
                            if (-1 !== a.ELIGIBLE_TABLE_TYPES.indexOf(e.type))
                                return (this.currentTable_ = e), !0;
                            e = e.parent;
                        }
                        return !1;
                    }
            ...
            8119: function (e, t) {
                ...
                (t.WalkerState = n), (n.STATE = {});
            },
            907: function (e, t, n) {
                Object.defineProperty(t, '__esModule', { value: !0 }),
                    (t.walkerMapping_ = t.walker = void 0);
                const r = n(4296),
                    i = n(1937),
                    o = n(3531),
                    s = n(4051);
                (t.walker = function (e, n, r, i, o) {
                    return (t.walkerMapping_[e.toLowerCase()] || t.walkerMapping_.dummy)(
                        n,
                        r,
                        i,
                        o,
            ...
            8835: function (e, t, n) {
                ...
                (t.splitAttribute = function (e) {
                    ...
                    (t.getSemanticRoot = function (e) {
                        if (e.hasAttribute(i.Attribute.TYPE) && !e.hasAttribute(i.Attribute.PARENT))
                            return e;
                        const t = r.querySelectorAllByAttr(e, i.Attribute.TYPE);
                        for (let e, n = 0; (e = t[n]); n++)
                            if (!e.hasAttribute(i.Attribute.PARENT)) return e;
                        return e;
                    }),
                    (t.getBySemanticId = function (e, t) {
                        return e.getAttribute(i.Attribute.ID) === t
                            ? e
                            : r.querySelectorAllByAttrValue(e, i.Attribute.ID, t)[0];
                    });
            },
        },
    ...
    !(function () {
        ...
        MathJax.loader && MathJax.loader.checkVersion('a11y/sre', t.q, 'a11y'),
            (0, e.r8)({ _: { a11y: { sre: n } } });
        ...
        if (MathJax.startup) {
            ...
            if ('undefined' != typeof window) window.SREfeature = { json: o };
                ...
                try {
                    o = MathJax.config.loader.require
                        .resolve(o + '/base.json')
                        .replace(/\/base\.json$/, '');
                } catch (e) {}
        ...
        MathJax.startup &&
            (('undefined' != typeof window ? window : __webpack_require__.g).SREfeature.custom =
                function (e) {
