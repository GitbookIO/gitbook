(function () {
    ...
    var __webpack_modules__ = {
                        ...
                        return (
                            ...
                            (n = (function (t) {
                                ...
                                return (
                                    ...
                                    (e.prototype.nodeSize = function (n, o, i) {
                                        if (
                                            (void 0 === o && (o = 1),
                                            void 0 === i && (i = null),
                                            !r.badSizes)
                                        )
                                            return t.prototype.nodeSize.call(this, n, o, i);
                                        var a = this.textContent(n),
                                            s = Array.from(a.replace(e.cjkPattern, '')).length;
                                        return [
                                            (Array.from(a).length - s) * this.options.cjkCharWidth +
                                                s * this.options.unknownCharWidth,
                            ...
                            (n.OPTIONS = i(
                                i({}, r.badCSS ? { fontSize: 16, fontFamily: 'Times' } : {}),
                                r.badSizes
                                    ? {
                                          cjkCharWidth: 1,
            ...
            7062: function (t, e, r) {
                ...
                var n = r(1168),
                    o = (function () {
                        function t() {
                            (this.root = new n.LiteElement('html', {}, [
                                (this.head = new n.LiteElement('head')),
                                (this.body = new n.LiteElement('body')),
                            ])),
                                (this.type = '');
                        }
                        return (
            ...
            5020: function (t, e, r) {
                ...
                var f = (function () {
                    function t() {}
                    return (
                        (t.prototype.parseFromString = function (t, e, r) {
                            void 0 === e && (e = 'text/html'), void 0 === r && (r = null);
                            for (
                                ...
                                var a = i.shift(),
                                    s = i.shift();
                                a && this.addText(r, o, a),
                                    s &&
                                        '>' === s.charAt(s.length - 1) &&
                                        ('!' === s.charAt(1)
                                            ? this.addComment(r, o, s)
                                            : (o =
                                                  '/' === s.charAt(1)
                                                      ? this.closeTag(r, o, s)
                                                      : this.openTag(r, o, s, i)));
                            }
                            return this.checkDocument(r, n), n;
                        }),
                        (t.prototype.addText = function (t, e, r) {
                            return (r = c.translate(r)), t.append(e, t.text(r));
                        }),
                        (t.prototype.addComment = function (t, e, r) {
                            return t.append(e, new p.LiteComment(r));
                        }),
                        (t.prototype.closeTag = function (t, e, r) {
                            for (
                                var n = r.slice(2, r.length - 1).toLowerCase();
                                t.parent(e) && t.kind(e) !== n;

                            )
                                e = t.parent(e);
                            return t.parent(e);
                        }),
                        (t.prototype.openTag = function (t, e, r, n) {
                            var o = this.constructor.PCDATA,
                                ...
                                c = r.replace(/^<.*?[\s\n>]/, '').split(l.attrsplit);
                            return (
                                (c.pop().match(/>$/) || c.length < 5) &&
                                    (this.addAttributes(t, s, c),
                                    t.append(e, s),
                                    i[a] ||
                                        r.match(/\/>$/) ||
                                        (o[a] ? this.handlePCDATA(t, s, a, n) : (e = s))),
                                e
                            );
                        }),
                        (t.prototype.addAttributes = function (t, e, r) {
                            for (var n = this.constructor.CDATA_ATTR; r.length; ) {
                                var o = a(r.splice(0, 5), 5),
                                    i = o[1],
                                    s = o[2],
                                    l = o[3],
                                    u = o[4],
                                    p = s || l || u || '';
                                n[i] || (p = c.translate(p)), t.setAttribute(e, i, p);
                            }
                        }),
                        (t.prototype.handlePCDATA = function (t, e, r, n) {
                            for (var o = [], i = '</' + r + '>', a = ''; n.length && a !== i; )
                                o.push(a), o.push(n.shift()), (a = n.shift());
                        ...
                        (t.prototype.checkDocument = function (t, e) {
                            ...
                            if (a) {
                                try {
                                    for (
                                        var l = s(t.childNodes(t.body(e))), c = l.next();
                                        !c.done;
                                        c = l.next()
                                    ) {
                                        if ((h = c.value) === a) break;
                                ...
                                s = t
                                    ...
                                    .map(function (t) {
                                        return (
                                            t.name +
                                            '="' +
                                            (i[t.name] ? t.value : n.protectAttribute(t.value)) +
                                            '"'
                                        );
                                    })
                                    .join(' '),
                                l = this.serializeInner(t, e, r);
                            return (
                                '<' +
                                a +
                                (s ? ' ' + s : '') +
                        ...
                        (t.prototype.serializeInner = function (t, e, r) {
                            var n = this;
                            return (
                                void 0 === r && (r = !1),
                ...
                var n = r(1168),
                    ...
                    s = function () {
                        (this.DOMParser = a.LiteParser),
                            ...
                            (this.HTMLElement = n.LiteElement),
            ...
            4907: function (t, e, r) {
                        ...
                        return (
                            ...
                            (e.prototype.tags = function (t, e, r) {
                                ...
                                for (var i = t; i; ) {
                                    ...
                                    '#text' !== a &&
                                        ...
                                        ((i = i),
                                        a === e && o.push(i),
                                        i.children.length && (n = i.children.concat(n))),
                                        (i = n.shift());
                                }
                                return o;
                            }),
                            (e.prototype.elementById = function (t, e) {
                                for (var r = [], n = t; n; ) {
                                    if ('#text' !== n.kind && '#comment' !== n.kind) {
                                        if ((n = n).attributes.id === e) return n;
                                        n.children.length && (r = n.children.concat(r));
                                    }
                                    n = r.shift();
                                }
                                return null;
                            ...
                            (e.prototype.getElements = function (t, e) {
                                var r,
                                    ...
                                    i = this.body(e);
                                try {
                                    for (var s = a(t), l = s.next(); !l.done; l = s.next()) {
                                        var c = l.value;
                                        if ('string' == typeof c)
                                            if ('#' === c.charAt(0)) {
                                                var u = this.elementById(i, c.slice(1));
                                                u && o.push(u);
                                            } else
                                                '.' === c.charAt(0)
                                                    ? (o = o.concat(
                                                          this.elementsByClass(i, c.slice(1)),
                                                      ))
                                                    : c.match(/^[-a-z][-a-z0-9]*$/i) &&
                                                      (o = o.concat(this.tags(i, c)));
                                        else
                                            Array.isArray(c)
                                                ? (o = o.concat(c))
                            ...
                            (e.prototype.insert = function (t, e) {
                                if ((t.parent && this.remove(t), e && e.parent)) {
                                    ...
                                    e.parent.children.splice(r, 0, t), (t.parent = e.parent);
                                }
                            }),
                            (e.prototype.remove = function (t) {
                            ...
                            (e.prototype.split = function (t, e) {
                                var r = new h.LiteText(t.value.slice(e));
                                return (
                                    (t.value = t.value.slice(0, e)),
                                    t.parent.children.splice(this.childIndex(t) + 1, 0, r),
                                    (r.parent = t.parent),
                                    r
                                );
                            }),
                            (e.prototype.next = function (t) {
                                var e = t.parent;
                                if (!e) return null;
                                var r = this.childIndex(t) + 1;
                                return r >= 0 && r < e.children.length ? e.children[r] : null;
                            }),
                            (e.prototype.previous = function (t) {
                                var e = t.parent;
                                if (!e) return null;
                                var r = this.childIndex(t) - 1;
                                return r >= 0 ? e.children[r] : null;
                            }),
                            (e.prototype.firstChild = function (t) {
                                return t.children[0];
                            }),
                            ...
                            (e.prototype.allAttributes = function (t) {
                                ...
                                try {
                                    for (
                                        var i = a(Object.keys(n)), s = i.next();
                                        !s.done;
                                        s = i.next()
                                    ) {
                                        var l = s.value;
                                        o.push({ name: l, value: n[l] });
                                    }
                                } catch (t) {
                                    e = { error: t };
                                } finally {
                            ...
                            (e.prototype.addClass = function (t, e) {
                                var r = (t.attributes.class || '').split(/ /);
                                r.find(function (t) {
                                    return t === e;
                                }) || (r.push(e), (t.attributes.class = r.join(' ')));
                            }),
                            (e.prototype.removeClass = function (t, e) {
                                var r = (t.attributes.class || '').split(/ /),
                                ...
                                n >= 0 && (r.splice(n, 1), (t.attributes.class = r.join(' ')));
                            }),
                            (e.prototype.hasClass = function (t, e) {
                            ...
                            (e.prototype.setStyle = function (t, e, r) {
                                t.styles ||
                                    (t.styles = new O.Styles(this.getAttribute(t, 'style'))),
                                    t.styles.set(e, r),
                                    (t.attributes.style = t.styles.cssText);
                            }),
                            (e.prototype.getStyle = function (t, e) {
                                if (!t.styles) {
                                    var r = this.getAttribute(t, 'style');
                                    if (!r) return '';
                                    t.styles = new O.Styles(r);
                                }
                            ...
                            (e.prototype.nodeSize = function (t, e, r) {
                                return void 0 === e && (e = 1), void 0 === r && (r = null), [0, 0];
                            }),
                            (e.prototype.nodeBBox = function (t) {
                ...
                (e.LiteAdaptor = v),
                    (e.liteAdaptor = function (t) {
                        return void 0 === t && (t = null), new v(null, t);
                    });
            },
            9515: function (t, e, r) {
                var n =
            ...
            235: function (t, e, r) {
                ...
                if (
                    ...
                    (function (t) {
                        ...
                        (t.versions = new Map()),
                            (t.ready = function () {
                                ...
                                try {
                                    for (var a = i(r), l = a.next(); !l.done; l = a.next()) {
                                        var c = l.value,
                                            u = s.Package.packages.get(c) || new s.Package(c, !0);
                                        o.push(u.promise);
                                    }
                                } catch (e) {
                                    t = { error: e };
                            ...
                            (t.load = function () {
                                ...
                                var l = [],
                                    c = function (r) {
                                        var n = s.Package.packages.get(r);
                                        n || (n = new s.Package(r)).provides(e.CONFIG.provides[r]),
                                            n.checkNoLoad(),
                                            l.push(
                                                n.promise.then(function () {
                                                    e.CONFIG.versionWarnings &&
                                                        n.isLoaded &&
                                                        !t.versions.has(s.Package.resolvePath(r)) &&
                                                        console.warn(
                                ...
                                return s.Package.loadAll(), Promise.all(l);
                            }),
                            (t.preLoad = function () {
                                ...
                                try {
                                    for (var a = i(n), l = a.next(); !l.done; l = a.next()) {
                                        var c = l.value,
                                            u = s.Package.packages.get(c);
                                        u ||
                                            (u = new s.Package(c, !0)).provides(
                                                e.CONFIG.provides[c],
                                            ),
                                            u.loaded();
                                    }
                            ...
                            (t.checkVersion = function (n, o, i) {
                                return (
                                    t.versions.set(s.Package.resolvePath(n), r),
                    ...
                    (0, a.combineDefaults)(e.MathJax.config, 'loader', {
                        ...
                        (0, a.combineWithMathJax)({ loader: c });
                    try {
                        for (
                            var p = i(e.MathJax.config.loader.pathFilters), f = p.next();
                            !f.done;
                            f = p.next()
                        ) {
                            var h = f.value;
                    ...
                    return (
                        ...
                        (t.prototype.makeDependencies = function () {
                            ...
                            l.CONFIG.dependencies.hasOwnProperty(u)
                                ? p.push.apply(p, s([], a(l.CONFIG.dependencies[u]), !1))
                                : 'core' !== u && p.push('core');
                            try {
            ...
            2388: function (t, e, r) {
                ...
                !(function (t) {
                    ...
                    function f(e) {
                        return s.visitTree(e, t.document);
                    }
                    function h() {
                        (s =
                            ...
                            (t.handler = g()),
                            t.handler && (l.handlers.register(t.handler), (t.document = L()));
                    }
                    function d() {
                        var e, r;
                        t.input && t.output && y();
                        ...
                        try {
                            for (var i = o(t.input), a = i.next(); !a.done; a = i.next()) {
                                var s = a.value,
                                    l = s.name.toLowerCase();
                                m(l, s), v(l, s), t.output && O(l, n, s);
                            }
                        } catch (t) {
                            e = { error: t };
                        } finally {
                        ...
                        (e.MathJax[r + '2mml'] = function (e, r) {
                            ...
                            (e.MathJax[r + '2mmlPromise'] = function (e, r) {
                                return (
                                    ...
                                    (r.format = n.name),
                                    l.handleRetriesFor(function () {
                                        return f(t.document.convert(e, r));
                                    })
                                );
                            });
                    }
                    function v(t, r) {
                        e.MathJax[t + 'Reset'] = function () {
                            ...
                            return r.reset.apply(r, a([], i(t), !1));
                        };
                    }
                    function M() {
                        var r,
                            ...
                            i = [];
                        try {
                            for (var a = o(e.CONFIG.input), s = a.next(); !s.done; s = a.next()) {
                                var l = s.value,
                                    c = t.constructors[l];
                                if (!c)
                                    throw Error(
                    ...
                    function g() {
                        ...
                        var a = t.constructors[i];
                        if (!a)
                            throw Error('Handler "' + i + '" is not defined (has it been loaded?)');
                        var s = new a(t.adaptor, 5);
                        try {
                    ...
                    void 0 === e.MathJax._.startup &&
                        ((0, l.combineDefaults)(e.MathJax.config, 'startup', {
                            ...
                            elements: null,
                            typeset: !0,
                            ready: s.defaultReady.bind(s),
                            pageReady: s.defaultPageReady.bind(s),
                        }),
                        (0, l.combineWithMathJax)({ startup: s, options: {} }),
                    ...
                    return (
                        ...
                        (t.prototype.setAttributes = function (t, e) {
                            ...
                            if (e.style && 'string' != typeof e.style)
                                try {
                                    for (
                                        var c = r(Object.keys(e.style)), u = c.next();
                                        !u.done;
                                        u = c.next()
                                    ) {
                                        var p = u.value;
                    ...
                    b = (function () {
                        function t(e, r, n) {
                            ...
                            (this.document = e),
                                ...
                                (this.math = new (this.options.MathList || v)()),
                                ...
                                if (!this.processed.isSet('compile')) {
                                    ...
                                    try {
                                        for (var c = i(o), u = c.next(); !u.done; u = c.next()) {
                                            var p = (l = u.value).inputData.recompile;
                                            l.state(p.state),
            ...
            6336: function (t, e, r) {
                ...
                e.MML =
                    ...
                    (n[v.MmlMpadded.prototype.kind] = v.MmlMpadded),
                    (n[M.MmlMphantom.prototype.kind] = M.MmlMphantom),
                    (n[b.MmlMfenced.prototype.kind] = b.MmlMfenced),
                    (n[E.MmlMenclose.prototype.kind] = E.MmlMenclose),
                    ...
                    (n[_.MmlMtable.prototype.kind] = _.MmlMtable),
                    (n[T.MmlMlabeledtr.prototype.kind] = T.MmlMlabeledtr),
                    (n[T.MmlMtr.prototype.kind] = T.MmlMtr),
                    (n[R.MmlMtd.prototype.kind] = R.MmlMtd),
                    (n[A.MmlMaligngroup.prototype.kind] = A.MmlMaligngroup),
                    (n[S.MmlMalignmark.prototype.kind] = S.MmlMalignmark),
                    (n[C.MmlMglyph.prototype.kind] = C.MmlMglyph),
                    (n[w.MmlSemantics.prototype.kind] = w.MmlSemantics),
                    (n[w.MmlAnnotation.prototype.kind] = w.MmlAnnotation),
                    (n[w.MmlAnnotationXML.prototype.kind] = w.MmlAnnotationXML),
                    ...
                    return (
                        ...
                        (r.prototype.copy = function (t) {
                            ...
                            if (((s.properties = i({}, this.properties)), this.attributes)) {
                                ...
                                try {
                                    for (
                                        var c = a(Object.keys(l)), u = c.next();
                                        !u.done;
                                        u = c.next()
                                    ) {
                                        var p = u.value;
                        ...
                        (r.prototype.setInheritedAttributes = function (t, e, n, o) {
                            ...
                            try {
                                for (
                                    var u = a(Object.keys(t)), p = u.next();
                                    !p.done;
                                    p = u.next()
                                ) {
                                    var f = p.value;
                            ...
                            (e.prototype.checkPrimes = function (t) {
                                ...
                                if (t.match(e)) {
                                    var r = this.constructor.remapPrimes,
                                        n = (0, u.unicodeString)(
                                            (0, u.unicodeChars)(t).map(function (t) {
                                                return r[t];
                                            }),
                                        );
                    ...
                    c = (function (t) {
                        ...
                        return (
                            ...
                            (e.prototype.setChildInheritedAttributes = function (t, e, r, n) {
                                ...
                                try {
                                    for (
                                        var u = a(this.childNodes), p = u.next();
                                        !p.done;
                                        p = u.next()
                                    ) {
                        ...
                        (r.prototype.getDataAttributes = function (t) {
                            ...
                            if (void 0 !== i) {
                                ...
                                if (i === l.TEXCLASS.OP && t.isKind('mi')) {
                                    var s = t.getText();
                                    a = !(s.length > 1 && s.match(c.MmlMi.operatorName));
                                }
                                a &&
            ...
            3683: function (t, e, r) {
                ...
                var l = r(5722),
                    ...
                    d = (function (t) {
                        function e(e, r, n) {
                            var o = this,
                                i = a((0, c.separateOptions)(n, f.HTMLDomStrings.OPTIONS), 2),
                                s = i[0],
                                l = i[1];
                            return (
                                ...
                                if (!this.processed.isSet('findMath')) {
                                    ...
                                    try {
                                        for (
                                            ...
                                            try {
                                                for (
                                                    var M = ((n = void 0), s(this.inputJax)),
                                                        b = M.next();
                                                    !b.done;
                                                    b = M.next()
                                                ) {
                                                    ...
                                                    if (E.processStrings) {
                                                        ...
                                                        try {
                                                            for (
                                                                ...
                                                                N = T.value;
                                                                var R = new this.options.MathItem(
                                                                    N.math,
                                                                    E,
                                                                    N.display,
                                                                    N.start,
                            ...
                            return new Promise(function (e, o) {
                                !(function i() {
                                    for (var l; ++r < n.length; ) {
                                        var c = (l = n[r]).item.apply(l, s([], a(t), !1));
            ...
            7233: function (t, e) {
                ...
                function u(t) {
                    var e,
                        ...
                        o = {};
                    try {
                        for (var i = r(c(t)), f = i.next(); !f.done; f = i.next()) {
                            var h = f.value,
                                d = Object.getOwnPropertyDescriptor(t, h),
                                y = d.value;
                            Array.isArray(y) ? (d.value = p([], y, !1)) : a(y) && (d.value = u(y)),
                                d.enumerable && (o[h] = d);
                        }
                    } catch (t) {
                        e = { error: t };
                ...
                function p(t, i, l) {
                    ...
                    try {
                        for (var y = r(c(i)), O = y.next(); !O.done; O = y.next()) {
                            d(O.value);
                        }
                    } catch (t) {
                        f = { error: t };
            ...
            8054: function (t, e) {
                ...
                function l(t) {
                    ...
                    try {
                        for (
                            var i = r(M.connect[t].children), a = i.next();
                            !a.done;
                            a = i.next()
                        ) {
                            var l = a.value;
                ...
                function u(t) {
                    ...
                    try {
                        for (
                            var o = r(M.connect[t].children), i = o.next();
                            !i.done;
                            i = o.next()
                        ) {
                            var a = i.value;
                ...
                function p(t) {
                    var e,
                        i,
                        a = o([], n(M.connect[t].children), !1),
                        s = this.styles[this.childName(t, a.shift())];
                    try {
                        for (var l = r(a), c = l.next(); !c.done; c = l.next()) {
                            var u = c.value;
                ...
                function d(t) {
                    var e,
                        ...
                        a = { width: '', style: '', color: '' };
                    try {
                        for (var l = r(s(this.styles[t])), c = l.next(); !c.done; c = l.next()) {
                            var u = c.value;
                            u.match(f) && '' === a.width
                                ? (a.width = u)
                                : u.match(h) && '' === a.style
                    ...
                    try {
                        for (
                            var p = r(M.connect[t].children), d = p.next();
                            !d.done;
                            d = p.next()
                        ) {
                            var y = d.value;
                ...
                function m(t) {
                    ...
                    try {
                        for (var u = r(l), p = u.next(); !p.done; p = u.next()) {
                            var f = p.value;
                            c.family = f;
                            try {
                                for (
                                    ...
                                    var y = d.value;
                                    if ((Array.isArray(c[y]) || '' === c[y]) && f.match(O[y]))
                                        if ('size' === y) {
                                            var m = n(f.split(/\//), 2),
                                                v = m[0],
                                                b = m[1];
                                            (c[y] = v), b && (c['line-height'] = b);
                                        } else
                                            '' === c.size &&
                                                (Array.isArray(c[y]) ? c[y].push(f) : (c[y] = f));
                                }
                            } catch (t) {
                                i = { error: t };
                            } finally {
            ...
            8671: function (t, e, r) {
                ...
                var n = r(9515),
                    ...
                    p = r(1248);
                MathJax.loader &&
                    MathJax.loader.checkVersion('adaptors/liteDOM', o.VERSION, 'adaptors'),
                    ...
                    MathJax.startup &&
                        (MathJax.startup.registerConstructor('liteAdaptor', i.liteAdaptor),
            ...
            7187: function (t, e, r) {
                ...
                var n = r(9515),
                    ...
                    Nt = r(7875),
                    _t = r(505);
                MathJax.loader && MathJax.loader.checkVersion('core', o.VERSION, 'core'),
                    (0, n.combineWithMathJax)({
                        _: {
                            adaptors: { HTMLAdaptor: i, browserAdaptor: a },
                            components: { global: n },
                            core: {
                                DOMAdaptor: s,
                                FindMath: l,
                    ...
                    MathJax.startup &&
                        (MathJax.startup.registerConstructor('HTMLHandler', ct.HTMLHandler),
                        MathJax.startup.registerConstructor('browserAdaptor', a.browserAdaptor),
            ...
            3226: function (t, e, r) {
                ...
                var n = '/',
                    o = {
                        core: ''.concat(n, '/core/core.js'),
                        'adaptors/liteDOM': ''.concat(n, '/adaptors/liteDOM/liteDOM.js'),
                        'input/tex': ''.concat(n, '/input/tex/tex.js'),
                        'input/tex-base': ''.concat(n, '/input/tex-base/tex-base.js'),
                        'input/tex-full': ''.concat(n, '/input/tex-full/tex-full.js'),
                        '[tex]/action': ''.concat(n, '/input/tex/extensions/action/action.js'),
                        '[tex]/all-packages': ''.concat(
                            n,
                            '/input/tex/extensions/all-packages/all-packages.js',
                        ),
                        '[tex]/autoload': ''.concat(
                            n,
                            '/input/tex/extensions/autoload/autoload.js',
                        ),
                        '[tex]/ams': ''.concat(n, '/input/tex/extensions/ams/ams.js'),
                        '[tex]/amscd': ''.concat(n, '/input/tex/extensions/amscd/amscd.js'),
                        '[tex]/bbox': ''.concat(n, '/input/tex/extensions/bbox/bbox.js'),
                        '[tex]/boldsymbol': ''.concat(
                            n,
                            '/input/tex/extensions/boldsymbol/boldsymbol.js',
                        ),
                        '[tex]/braket': ''.concat(n, '/input/tex/extensions/braket/braket.js'),
                        '[tex]/bussproofs': ''.concat(
                            n,
                            '/input/tex/extensions/bussproofs/bussproofs.js',
                        ),
                        '[tex]/cancel': ''.concat(n, '/input/tex/extensions/cancel/cancel.js'),
                        '[tex]/centernot': ''.concat(
                            n,
                            '/input/tex/extensions/centernot/centernot.js',
                        ),
                        '[tex]/color': ''.concat(n, '/input/tex/extensions/color/color.js'),
                        '[tex]/colorv2': ''.concat(n, '/input/tex/extensions/colorv2/colorv2.js'),
                        '[tex]/configmacros': ''.concat(
                            n,
                            '/input/tex/extensions/configmacros/configmacros.js',
                        ),
                        '[tex]/enclose': ''.concat(n, '/input/tex/extensions/enclose/enclose.js'),
                        '[tex]/extpfeil': ''.concat(
                            n,
                            '/input/tex/extensions/extpfeil/extpfeil.js',
                        ),
                        '[tex]/html': ''.concat(n, '/input/tex/extensions/html/html.js'),
                        '[tex]/mathtools': ''.concat(
                            n,
                            '/input/tex/extensions/mathtools/mathtools.js',
                        ),
                        '[tex]/mhchem': ''.concat(n, '/input/tex/extensions/mhchem/mhchem.js'),
                        '[tex]/newcommand': ''.concat(
                            n,
                            '/input/tex/extensions/newcommand/newcommand.js',
                        ),
                        '[tex]/noerrors': ''.concat(
                            n,
                            '/input/tex/extensions/noerrors/noerrors.js',
                        ),
                        '[tex]/noundefined': ''.concat(
                            n,
                            '/input/tex/extensions/noundefined/noundefined.js',
                        ),
                        '[tex]/physics': ''.concat(n, '/input/tex/extensions/physics/physics.js'),
                        '[tex]/require': ''.concat(n, '/input/tex/extensions/require/require.js'),
                        '[tex]/setoptions': ''.concat(
                            n,
                            '/input/tex/extensions/setoptions/setoptions.js',
                        ),
                        '[tex]/tagformat': ''.concat(
                            n,
                            '/input/tex/extensions/tagformat/tagformat.js',
                        ),
                        '[tex]/textmacros': ''.concat(
                            n,
                            '/input/tex/extensions/textmacros/textmacros.js',
                        ),
                        '[tex]/unicode': ''.concat(n, '/input/tex/extensions/unicode/unicode.js'),
                        '[tex]/verb': ''.concat(n, '/input/tex/extensions/verb/verb.js'),
                        '[tex]/cases': ''.concat(n, '/input/tex/extensions/cases/cases.js'),
                        '[tex]/empheq': ''.concat(n, '/input/tex/extensions/empheq/empheq.js'),
                        'input/mml': ''.concat(n, '/input/mml/mml.js'),
                        'input/mml/entities': ''.concat(n, '/input/mml/entities/entities.js'),
                        '[mml]/mml3': ''.concat(n, '/input/mml/extensions/mml3/mml3.js'),
                        'input/asciimath': ''.concat(n, '/input/asciimath/asciimath.js'),
                        'output/chtml': ''.concat(n, '/output/chtml/chtml.js'),
                        'output/chtml/fonts/tex': ''.concat(n, '/output/chtml/fonts/tex/tex.js'),
                        'output/svg': ''.concat(n, '/output/svg/svg.js'),
                        'output/svg/fonts/tex': ''.concat(n, '/output/svg/fonts/tex/tex.js'),
                        'a11y/assistive-mml': ''.concat(n, '/a11y/assistive-mml/assistive-mml.js'),
                        'a11y/semantic-enrich': ''.concat(
                            n,
                            '/a11y/semantic-enrich/semantic-enrich.js',
                        ),
                        'a11y/complexity': ''.concat(n, '/a11y/complexity/complexity.js'),
                        'a11y/explorer': ''.concat(n, '/a11y/explorer/explorer.js'),
                        'a11y/sre': ''.concat(n, '/a11y/sre/sre.js'),
                        'ui/lazy': ''.concat(n, '/ui/lazy/lazy.js'),
                        'ui/menu': ''.concat(n, '/ui/menu/menu.js'),
                        'ui/safe': ''.concat(n, '/ui/safe/safe.js'),
                        'mml-chtml': ''.concat(n, '/mml-chtml/mml-chtml.js'),
                        'mml-svg': ''.concat(n, '/mml-svg/mml-svg.js'),
                        'tex-chtml': ''.concat(n, '/tex-chtml/tex-chtml.js'),
                        'tex-svg': ''.concat(n, '/tex-svg/tex-svg.js'),
                        'tex-mml-chtml': ''.concat(n, '/tex-mml-chtml/tex-mml-chtml.js'),
                        'tex-mml-svg': ''.concat(n, '/tex-mml-svg/tex-mml-svg.js'),
                        loader: ''.concat(n, '/loader/loader.js'),
                        startup: ''.concat(n, '/startup/startup.js'),
                    };
            },
            1585: function (t, e, r) {
                r.r(e);
                ...
                MathJax.loader && MathJax.loader.checkVersion('startup', o.VERSION, 'startup'),
                    (0, n.combineWithMathJax)({
                        _: { components: { loader: i, package: a, startup: s } },
                    });
                var c,
                    u = {
                    ...
                    p = Array.from(Object.keys(u)).filter(function (t) {
                        return (
                            '[tex]' === t.substr(0, 5) &&
                            '[tex]/autoload' !== t &&
                            '[tex]/colorv2' !== t &&
                ...
                (0, n.combineDefaults)(MathJax.config.loader, 'dependencies', u),
                    (0, n.combineDefaults)(MathJax.config.loader, 'paths', {
                        tex: '[mathjax]/input/tex/extensions',
                        mml: '[mathjax]/input/mml/extensions',
                        sre: '[mathjax]/sre/mathmaps',
                    }),
                    (0, n.combineDefaults)(MathJax.config.loader, 'provides', f),
                    (0, n.combineDefaults)(MathJax.config.loader, 'source', {
                        '[tex]/amsCd': '[tex]/amscd',
    ...
    !(function () {
        ...
        var _require = __webpack_require__(235),
            ...
            _require2 = __webpack_require__(9515),
            combineDefaults = _require2.combineDefaults,
            combineConfig = _require2.combineConfig;
        ...
        if ('node-main' === path.basename(dir)) {
            (CONFIG.paths.mathjax = path.dirname(dir)),
                combineDefaults(CONFIG, 'source', __webpack_require__(3226).q);
            var ROOT = path.resolve(dir, '../../../js'),
                REQUIRE = MathJax.config.loader.require;
            MathJax._.mathjax.mathjax.asyncLoad = function (t) {
        ...
        var init = function () {
            ...
            return (
                combineConfig(MathJax.config, t),
                Loader.load
                    .apply(Loader, _toConsumableArray(CONFIG.load))
                    .then(function () {
                        return CONFIG.ready();
                    })
                    .then(function () {
