...
Generator.prototype.finish = function() {
    ...
    .then(function() {
        ...
        if(that.options.ebook && that.options.ebook.justification){
            if (_.contains(["original", "left", "justify"], that.options.ebook.justification)) {
                _.extend(_options, {
                    "--change-justification": that.options.ebook.justification
                });
            } else {
                d.reject({ message: "Invalid ebook.justification option. Must be one of: original, left, justify."})
            }
        }
