    ...
    .then(function() {
        ...
        .spread(function(headerTpl, footerTpl) {
            ...
            return options = extend(options, {
                ...
                '--pdf-page-margin-left':   String(pdfOptions.pageMargin.left),
                '--pdf-page-margin-right':  String(pdfOptions.pageMargin.right),
                '--pdf-page-margin-top':    String(pdfOptions.pageMargin.top),
                '--pdf-page-margin-bottom': String(pdfOptions.pageMargin.bottom),
