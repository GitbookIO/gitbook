...
The platform [GitBook.io](https://www.gitbook.io/) is like a "Heroku for books": you can create a book on it (public, paid, or private) and update it using **git push**.
