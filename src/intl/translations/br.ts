export const br = {
    ...
    search: 'Busca',
    search_or_ask: 'Pergunte ou busque',
    ...
    search_ask_no_answer: 'Nenhuma resposta foi encontrada para sua pergunta, tente uma outra pergunta.',
    ...
    cookies_prompt:
        'Este site usa cookies para entregar suas funcionalidades e analizar o tráfego. Ao navegar neste site, você aceita os ${1}.',
