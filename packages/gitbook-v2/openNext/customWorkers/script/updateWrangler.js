...
// The preview URL is in the format https://<versionId>-gitbook-open-v2-preview.gitbook.workers.dev
const previewUrl = `https://${versionId.split('-')[0]}-gitbook-open-v2-preview.gitbook.workers.dev`;
