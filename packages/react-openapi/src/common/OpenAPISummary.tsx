...
export function OpenAPISummary(props: {
    ...
    return (
        <div className="openapi-summary" id={operation.summary ? undefined : context.id}>
            {((operation.deprecated && !context.hideSummaryAndDescription) || operation['x-stability']) ? (
                <div className="openapi-summary-tags">
                    {operation.deprecated && !context.hideSummaryAndDescription && <div className="openapi-deprecated">Deprecated</div>}
