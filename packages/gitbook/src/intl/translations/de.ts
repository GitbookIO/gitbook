...
export const de: TranslationLanguage = {
    ...
    search: 'Suche',
    clear: 'Löschen',
    table_filtered_by_selection: 'Passend zu deiner Auswahl: ${1}',
    ...
    ai_chat_view_activity: 'Aktivität anzeigen',
    ai_chat_explored: 'Kurz erkundet',
    ai_chat_explored_with: 'Erkundet mit ${1}',
    tool_count: '${1} Werkzeug',
    tool_count_plural: '${1} Werkzeuge',
