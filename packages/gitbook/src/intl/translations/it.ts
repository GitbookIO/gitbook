...
export const it: TranslationLanguage = {
    ...
    search: 'Cerca',
    clear: 'Cancella',
    table_filtered_by_selection: 'Corrisponde alla tua selezione: ${1}',
    ...
    ai_chat_view_activity: 'Visualizza attività',
    ai_chat_explored: 'Esplorato brevemente',
    ai_chat_explored_with: 'Esplorato con ${1}',
    tool_count: '${1} strumento',
    tool_count_plural: '${1} strumenti',
    ...
    ai_chat_context_pages_youve_read: 'La pagina su cui ti trovi ora',
    ai_chat_context_info_provided_by_the_site: 'Informazioni su di te fornite dal sito',
