...
export const es: TranslationLanguage = {
    ...
    search: 'Buscar',
    clear: 'Limpiar',
    table_filtered_by_selection: 'Coincide con tu selección: ${1}',
    ...
    ai_chat_view_activity: 'Ver actividad',
    ai_chat_explored: 'Explorado brevemente',
    ai_chat_explored_with: 'Explorado con ${1}',
    tool_count: '${1} herramienta',
    tool_count_plural: '${1} herramientas',
    ...
    ai_chat_context_pages_youve_read: 'La página en la que estás ahora',
    ai_chat_context_info_provided_by_the_site: 'Información sobre ti proporcionada por el sitio',
