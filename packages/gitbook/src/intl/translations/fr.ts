...
export const fr: TranslationLanguage = {
    ...
    search: 'Rechercher',
    clear: 'Effacer',
    table_filtered_by_selection: 'Correspond à votre sélection : ${1}',
    ...
    ai_chat_view_activity: 'Voir l’activité',
    ai_chat_explored: 'Exploré brièvement',
    ai_chat_explored_with: 'Exploré avec ${1}',
    tool_count: '${1} outil',
    tool_count_plural: '${1} outils',
    ...
    ai_chat_context_pages_youve_read: 'La page sur laquelle vous êtes actuellement',
    ai_chat_context_info_provided_by_the_site: 'Informations vous concernant fournies par le site',
