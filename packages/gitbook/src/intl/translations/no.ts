...
export const no: TranslationLanguage = {
    ...
    search: 'Søk',
    clear: 'Tøm',
    table_filtered_by_selection: 'Samsvarer med valget ditt: ${1}',
    ...
    ai_chat_view_activity: 'Se aktivitet',
    ai_chat_explored: 'Utforsket kort',
    ai_chat_explored_with: 'Utforsket med ${1}',
    tool_count: '${1} verktøy',
    tool_count_plural: '${1} verktøy',
