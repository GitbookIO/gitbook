...
export const nl: TranslationLanguage = {
    ...
    notfound_link_opens: 'In plaats daarvan wordt ${1} geopend.',
    ...
    ai_chat_view_activity: 'Activiteit bekijken',
    ai_chat_explored: 'Kort verkend',
    ai_chat_explored_with: 'Verkend met ${1}',
    tool_count: '${1} tool',
    ...
    ai_chat_context_pages_youve_read: 'De pagina waar je nu op bent',
    ai_chat_context_info_provided_by_the_site: 'Informatie over jou verstrekt door de site',
