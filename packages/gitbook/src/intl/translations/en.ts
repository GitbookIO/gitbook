export const en = {
    ...
    search: 'Search',
    clear: 'Clear',
    table_filtered_by_selection: 'Matching your selection: ${1}',
    ...
    search_scope_variant_all: 'All content',
    search_scope_variant_all_description: 'Every available variant',
    ask: 'Ask',
    search_ask: 'Ask "${1}"',
    ...
    ai_chat_view_activity: 'View activity',
    ai_chat_explored: 'Explored briefly',
    ai_chat_explored_with: 'Explored with ${1}',
    tool_count: '${1} tool',
    tool_count_plural: '${1} tools',
    ...
    ai_chat_context_pages_youve_read: "The page you're on now",
    ai_chat_context_info_provided_by_the_site: 'Info about you provided by the site',
