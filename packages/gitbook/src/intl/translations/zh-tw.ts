...
export const zh_tw: TranslationLanguage = {
    ...
    search: '搜尋',
    clear: '清除',
    table_filtered_by_selection: '符合你的選擇：${1}',
    ...
    auth_consent_request: '${1} 想代表您存取 ${2}。',
    auth_client_website: '網站',
    auth_verified: '已驗證',
    auth_unverified: '未驗證',
    auth_unverified_title: 'GitBook 尚未驗證此用戶端',
    auth_unverified_description: '只有在您認得此應用程式並信任其存取 ${1} 時才批准。',
    auth_code_preamble: '批准後，授權碼將傳送至：',
    auth_redirect_uri_label: '重新導向 URI',
    auth_trust_client: '我認得並信任此用戶端',
    auth_approve: '批准',
    auth_deny: '拒絕',
    auth_error_title: '發生錯誤',
    auth_expired_title: '此授權連結已過期',
    auth_expired_description: '請從應用程式重新開始登入。',
    auth_error_invalid_request: '請求無效。請從應用程式重新開始。',
    auth_error_failed: '我們無法完成授權。請求可能已過期 — 請從應用程式重新開始。',
};
