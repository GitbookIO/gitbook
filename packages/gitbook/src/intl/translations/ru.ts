...
export const ru: TranslationLanguage = {
    ...
    search: 'Поиск',
    clear: 'Очистить',
    table_filtered_by_selection: 'Соответствует вашему выбору: ${1}',
    ...
    ai_chat_view_activity: 'Просмотреть активность',
    ai_chat_explored: 'Кратко изучено',
    ai_chat_explored_with: 'Изучено с помощью ${1}',
    tool_count: '${1} инструмент',
    tool_count_plural: '${1} инструментов',
