...
export function HighlightQuery(props: {
    ...
    const { query, text, highlight = ['text-bold', 'bg-primary-100', 'text-contrast-primary-100', 'dark:bg-primary-700', 'dark:text-contrast-primary-700', 'px-0.5', '-mx-0.5', 'py-0.5', 'rounded'] } = props;
