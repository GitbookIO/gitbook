        ...
        <RadixPopover.Root {...rootProps}>
            ...
            <RadixPopover.Portal>
                <RadixPopover.Content
                    ...
                    className={tcls(
                        'z-50 max-h-[var(--radix-popover-content-available-height)] max-w-xs animate-scaleIn overflow-y-auto circular-corners:rounded-3xl rounded-corners:rounded-md bg-tint px-4 py-3 text-sm text-tint depth-subtle:shadow-lg shadow-tint outline-none ring-1 ring-tint',
