    ...
    return (
        <>
            <Button
                ...
                className="layout-default:hidden layout-wide:4xl:hidden page-no-outline:hidden layout-wide:max-xl:hidden"
            />
            <Button
                icon="block-quote"
                size="xsmall"
...
export function PageAsideCloseButton() {
    return (
        <Button
            ...
            iconOnly
            variant="blank"
            className="layout-wide:4xl:hidden max-lg:hidden layout-default:xl:hidden"
            onClick={() => {
                document.body.classList.toggle(globalClassName);
            }}
        />
